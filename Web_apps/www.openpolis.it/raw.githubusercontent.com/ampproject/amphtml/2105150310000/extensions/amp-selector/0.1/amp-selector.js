...
import {
    AmpEvents
} from '../../../src/core/constants/amp-events';
import {
    CSS
} from '../../../build/amp-selector-0.1.css';
import {
    Keys
} from '../../../src/core/constants/key-codes';
import {
    Services
} from '../../../src/services';
import {
...
export class AmpSelector extends AMP.BaseElement {
    ...
    buildCallback() {
        ...
        if (kbSelectMode) {
            ...
            userAssert(!(this.isMultiple_ && kbSelectMode == KEYBOARD_SELECT_MODES.SELECT),
        ...
        this.action_.addToAllowlist(
            TAG, ['clear', 'selectDown', 'selectUp', 'toggle'], ['email']
        );
