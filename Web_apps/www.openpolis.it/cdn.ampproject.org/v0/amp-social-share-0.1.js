(self.AMP = self.AMP || []).push({
    ...
    f: (function(AMP, _) {
        'use strict';
        var g = "function" == typeof Object.create ? Object.create : function(a) {
            function b() {}
            b.prototype = a;
            return new b
        };
        ...
        function x(a) {
            ...
            if (!a) return b;
            for (var c; c = w.exec(a);) {
                var d = u(c[1], c[1]);
                c = c[2] ? u(c[2].replace(/\+/g, " "), c[2]) : "";
                b[d] = c
            }
            return b
        };
        ...
        function D(a, b, c) {
            return C().assert(a, b, c, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0)
        };
        ...
        function K(a) {
            ...
            for (e in c) {
                var f = e.match(d);
                if (f) {
                    var h = f[1][0].toLowerCase() + f[1].substr(1);
                    a[b(h)] = c[e]
                }
            }
            return a
        ...
        function L(a, b, c) {
            try {
                var d = a.open(b, c, "resizable,scrollbars,width=640,height=480")
            } catch (h) {
                if (B.dev) var e = B.dev;
            ...
            if (!(c = d || "_top" == c)) {
                var f;
                "number" !== typeof f && (f = 0);
                c = 41 < f + 8 ? !1 : -1 !== "resizable,scrollbars,width=640,height=480".indexOf("noopener", f)
            }
            c || a.open(b, "_top")
        };
        ...
        var R = AMP.BaseElement;
        Q.prototype = g(R.prototype);
        ...
        Q.F = R.prototype;
        Q.prerenderAllowed = function() {
            return !0
        };
        Q.prototype.isLayoutSupported = function() {
            return !0
        };
        Q.prototype.buildCallback = function() {
            var a = this,
                b = this.element,
                c = D(b.getAttribute("type"), "The type attribute is required. %s", b);
            D(!/\s/.test(c), "Space characters are not allowed in type attribute value. %s", b);
            this.C = E(this.win, "platform");
            var d = "share" in this.win.navigator;
            if ("system" === c) {
                if (!d) {
                    P(b);
                    return
                }
            } else if (d && this.win.document.querySelectorAll("amp-social-share[type=system][data-mode=replace]").length) {
                P(b);
                return
            }
            var e = O[c] || {};
            e.obsolete ? (P(b), C().warn("amp-social-share", "Skipping obsolete share button " +
                c)) : (this.j = D(b.getAttribute("data-share-endpoint") || e.shareEndpoint, "The data-share-endpoint attribute is required. %s", b), Object.assign(this.A, e.defaultParams, K(b)), this.o = e.bindings, b.setAttribute("role", "button"), b.hasAttribute("tabindex") || b.setAttribute("tabindex", "0"), b.getAttribute("aria-label") || b.setAttribute("aria-label", "Share by " + c), b.addEventListener("click", function() {
                U(a)
            }), b.addEventListener("keydown", this.D.bind(this)), b.classList.add("amp-social-share-" + c))
        };
        Q.prototype.layoutCallback = function() {
            var a = this;
            if (!this.j) {
                r || (r = Promise.resolve(void 0));
                var b = r;
                return b
            }
            var c = M(this.j, N(this.A)),
                d = G(this.element, "url-replace"),
                e = {};
            this.o && this.o.forEach(function(f) {
                var h = f.toUpperCase();
                e[h] = a.A[f]
            });
            return d.expandUrlAsync(c, e).then(function(f) {
                a.h = f;
                var h = G(a.element, "url").parse(f).protocol,
                    v = "mailto:" === h,
                    J = "sms:" === h;
                a.B = a.C.isIos() && (v || J) ? "_top" : a.element.hasAttribute("data-target") ? a.element.getAttribute("data-target") : "_blank";
                J && (a.h = a.h.replace("?",
                    "?&"))
            })
        };
