(self.AMP = self.AMP || []).push({
    ...
    f: (function(AMP, _) {
        'use strict';
        var g = self.AMP_CONFIG || {},
            k = ("string" == typeof g.cdnProxyRegex ? new RegExp(g.cdnProxyRegex) : g.cdnProxyRegex) || /^https:\/\/([a-zA-Z0-9_-]+\.)?cdn\.ampproject\.org$/;

        function l(a) {
            if (self.document && self.document.head && (!self.location || !k.test(self.location.origin))) {
                var b = self.document.head.querySelector('meta[name="' + a + '"]');
                b && b.getAttribute("content")
            }
        }
        g.cdnUrl || l("runtime-host");
        g.geoApiUrl || l("amp-geo-api");
        ...
        function p(a) {
            a = a.ownerDocument || a;
            n && n.ownerDocument === a || (n = a.createElement("div"));
            return q
        }
        ...
        var r, u = "Webkit webkit Moz moz ms O o".split(" ");
        ...
        K.prototype.build = function() {
            ...
            this.j = J.cloneNode(!0);
            this.B.appendChild(this.j);
            a = !!this.h.getPlaceholder();
            var b = this.h.hasAttribute("poster");
            if (a = !(a || b)) a = this.h.tagName, a = I[a] || C(a);
            a && this.B.classList.add("i-amphtml-loader-background");
            if (a = !(50 > this.A || 50 > this.o)) a = this.h.getPlaceholder(), a = !(a && a.classList.contains("i-amphtml-blurry-placeholder"));
            if (a && ("AMP-AD" == this.h.tagName ? this.j.classList.add("i-amphtml-new-loader-size-default") : 50 > this.A ||
                    50 > this.o || !(100 >= this.A || 100 >= this.o) ? this.j.classList.add("i-amphtml-new-loader-size-default") : this.j.classList.add("i-amphtml-new-loader-size-small"), a = this.h.hasAttribute("poster") ? !0 : (a = this.h.getPlaceholder()) ? "AMP-IMG" == a.tagName || "IMG" == a.tagName ? !0 : !1 : !1, a && this.j.classList.add("i-amphtml-new-loader-has-shim"), b = "AMP-AD" == this.h.tagName ? {
                        content: p(this.h)(H)
                    } : C(this.h.tagName) ? {
                        content: p(this.h)(F)
                    } : this.h.createLoaderLogo(), a = b.color, b = void 0 === b.content ? p(this.h)(G) : b.content, this.j.querySelector(".i-amphtml-new-loader-logo").appendChild(b),
                    a)) {
                b = this.j;
                var c = v(b.style, "color", void 0);
                c && (c.startsWith("--") ? b.style.setProperty(c, a) : b.style[c] = a)
            }
        };

        function L() {}
        L.prototype.initializeLoader = function(a, b, c, d, e) {
            var f = Math.min(c, 600);
            (new K(a, b, d, e)).build();
            d = {
                "--loader-delay-offset": f + "ms"
            };
            a = a.style;
            for (var h in d) a.setProperty(v(a, h), String(d[h]), "important")
        };
        (function(a) {
            a.registerServiceForDoc("loader", L);
            m(a.win).addDocFactory(function(b) {
                w(b, function() {})
            })
        })(self.AMP);
    })
