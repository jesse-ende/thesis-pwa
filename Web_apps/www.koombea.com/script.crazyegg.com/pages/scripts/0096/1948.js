...
"undefined" == typeof CE2 && (CE2 = {}), CE2.userDataToJs = function(t) {
...
}, CE_USER_DATA_URL = "https://script.crazyegg.com/pages/data-scripts/0096/1948.json", CE2.debugEnabled = function() {
    ...
    if (!(-1 < CE2.INCLUDED_SCRIPTS.indexOf(t))) {
        ...
        CE2.debug("Loading script " + t), a.src = t, a.type = "text/javascript", a.async = !0;
        var r = document.getElementsByTagName("script")[0];
        return r.parentNode.insertBefore(a, r), a.onload = a.onreadystatechange = function() {
            a.readyState && !/complete|loaded/.test(a.readyState) || (CE2.LOADED_SCRIPTS.push(t), CE2.runLoadedScriptCallbacks(t), a.onload = null, a.onreadystatechange = null)
    ...
    e.onreadystatechange = function() {
        if (4 == e.readyState) try {
            200 == e.status && e.responseText && (CE2.data = JSON.parse(e.responseText), "undefined" != typeof CE_LOCAL_SCRIPT_HOST && (CE2.data.common_script_url = CE_LOCAL_SCRIPT_HOST + "/pages/versioned/common-scripts-source/latest.js", CE2.data.tracking_script_url = CE_LOCAL_SCRIPT_HOST + "/pages/versioned/tracking-scripts-source/latest.js", CE2.data.trackingpagestate_script_url = CE_LOCAL_SCRIPT_HOST + "/pages/versioned/trackingpagestate-scripts-source/latest.js"), window.CE_USER_COMMON_SCRIPT_URL || (window.CE_USER_COMMON_SCRIPT_URL = CE2.data.common_script_url), CE2.userDataToJs(CE2.data), "ok" === CE2.data.status && CE2.loadCommonScript())
        } catch (t) {
