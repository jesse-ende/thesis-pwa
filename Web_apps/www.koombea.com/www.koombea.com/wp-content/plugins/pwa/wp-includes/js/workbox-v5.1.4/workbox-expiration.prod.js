this.workbox = this.workbox || {}, this.workbox.expiration = function(t, e, s, i, a, n, h) {
    "use strict";
    try {
    ...
    class c {
        constructor(t) {
            this.t = t, this.s = new i.DBWrapper("workbox-expiration", 1, {
    ...
    return t.CacheExpiration = o, t.ExpirationPlugin = class {
        constructor(t = {}) {
            ...
            }, this.N = t, this.m = t.maxAgeSeconds, this.g = new Map, t.purgeOnQuotaError && h.registerQuotaErrorCallback(() => this.deleteCacheAndMetadata())
        }
        D(t) {
