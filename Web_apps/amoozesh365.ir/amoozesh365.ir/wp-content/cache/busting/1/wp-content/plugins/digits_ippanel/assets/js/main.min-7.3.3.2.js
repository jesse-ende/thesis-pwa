jQuery(function() {
    ...
    function update_username_field($this) {
        ...
        usernameid.wrap('<div class="digcon"></div>').before('<div class="dig_wc_countrycodecontainer dig_wc_logincountrycodecontainer">' + '<input type="text" name="' + dig_ccd_name + '" class="' + dig_ext + 'input-text countrycode dig_wc_logincountrycode" ' + 'value="' + ccd + '" maxlength="6" size="3" placeholder="' + ccd + '" ' + dig_mainattr + "/></div>");
        ...
        usernameid.on("keyup change focusin", function(e) {
            ...
            if (dig_main) {
                ...
                if (jQuery.isNumeric(con) && con.length > 0 && jQuery.isNumeric(ccdval) && ccdval.length > 0) jQuery("#" + dig_main).val(ccdval + "" + con);
