self.babelHelpers = {
    ...
    const u = e => l <= e,
        ...
        d = function(r, t, n) {
            ...
            const i = ["%cworkbox", `background: ${n}; color: white; padding: 2px 0.5em; ` + "border-radius: 0.5em;"];
            console[r](...i, ...t)
        },
        h = () => {
    ...
    var y, g;
    Object.keys(b).forEach(e => (e = e, g = b[e], p[e] = ((...r) => d(e, r, g)), void(p.unprefixed[e] = ((...r) => d(e, r)))));
    var v = new class {
        constructor() {
            try {
                ...
                return yield t.transaction([e], "readonly", function(t, n) {
                    ...
                    (r.index ? o.index(r.index) : o).openCursor(r.query, r.direction).onsuccess = function(e) {
                        ...
                        if (t) {
                            ...
                            i.push(r.includeKeys ? {
                                primaryKey: e,
                                key: o,
                                value: c
                            } : c), r.count && i.length >= r.count ? n(i) : t.continue()
                        } else n(i)
                    }
                })
            })()
        ...
        transaction(e, r, t) {
            ...
            return babelHelpers.asyncToGenerator(function*() {
                return yield n.open(), yield new Promise(function(o, i) {
                    ...
                    const l = {};
                    for (const r of e) l[r] = c.objectStore(r);
                    t(l, function(e) {
                        return o(e)
                    }, function() {
    ...
    const O = e => {
        ...
        R = (() => {
            var e = babelHelpers.asyncToGenerator(function*(e, r, n, o = []) {
                if (!n) throw new t("cache-put-with-no-response", {
                    url: O(r.url)
                });
                let i = yield W(r, n, o);
                if (!i) return;
                const c = yield caches.open(e), l = k(o, m);
                let u = l.length > 0 ? yield A(e, r): null;
                try {
                    yield c.put(r, i)
                } catch (e) {
                    throw "QuotaExceededError" === e.name && (yield q()), e
                }
                for (let t of l) yield t[m].call(t, {
                    cacheName: e,
                    request: r,
                    oldResponse: u,
                    newResponse: i
        ...
        A = (P = babelHelpers.asyncToGenerator(function*(e, r, t, n = []) {
            ...
            for (let i of n) L in i && (o = yield i[L].call(i, {
                cacheName: e,
                request: r,
                matchOptions: t,
                cachedResponse: o
    ...
    const W = (S = babelHelpers.asyncToGenerator(function*(e, r, t) {
        let n = r,
            o = !1;
        for (let r of t)
            if (E in r && (o = !0, !(n = yield r[E].call(r, {
                    request: e,
                    response: n
                })))) break;
        ...
        j = {
            fetch: (() => {
                var e = babelHelpers.asyncToGenerator(function*(e, r, n = []) {
                    ...
                    try {
                        for (let r of n) x in r && (e = yield r[x].call(r, {
                            request: e.clone()
                        }))
                    } catch (e) {
                    ...
                    try {
                        ...
                        for (let r of o) yield r[H].call(r, {
                            error: e,
