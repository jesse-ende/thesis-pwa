var OneTrustStub = function(e) {
    "use strict";
    var t, o, n, a, i, r, s, l, c, p, u, d, m, h, g, f, b, A, y, C, v, I, S, w, T, L, R, B, D, _, G, E, P, U, k, O, F, V, x, N, H, M, j, K, z, q, J, W, Y, Q, X, Z, $, ee = new function() {
    ...
    var te = "geo",
        oe = "otpreview",
        ne = (($ = {})[F.Days] = "PCenterVendorListLifespanDay", $[F.Weeks] = "LfSpnWk", $[F.Months] = "PCenterVendorListLifespanMonth", $[F.Years] = "LfSpnYr", ae.prototype.initConsentSDK = function() {
            ...
            this.setDomainDataFileURL(), this.otFetch(ee.bannerDataParentURL, this.getLocation.bind(this))
            ...
            if (t.OneTrust && t.OneTrust.geolocationResponse) {
                ...
                var n = this.readCookieParam(ee.optanonCookieName, ee.geolocationCookiesParam);
                if (n || e.SkipGeolocation) {
                    var a = n.split(";")[0],
                        i = n.split(";")[1];
                    this.setGeoLocation(a, i), this.addBannerSDKScript(e)
        ...
        }, ae.prototype.otFetch = function(e, t, o) {
            ...
            o.setAttribute("src", e), o.async = !0, o.type = "text/javascript", this.crossOrigin && o.setAttribute("crossorigin", this.crossOrigin), document.getElementsByTagName("head")[0].appendChild(o), new RegExp("^file://", "i").test(e) || ee.mobileOnlineURL.push(e), t && (o.onload = o.onerror = function() {
                t()
            })
        }, ae.prototype.getRegionSet = function(e) {
            var t, o, n, a = ee.userLocation,
                i = e.RuleSet.filter(function(e) {
                    return !0 === e.Default
                });
            if (!a.country && !a.state) return i && 0 < i.length ? i[0] : null;
            ...
            var o, n, a, i, r = this.getCookie(e);
            if (r) {
                for (n = {}, a = r.split("&"), o = 0; o < a.length; o += 1) i = a[o].split("="), n[decodeURIComponent(i[0])] = decodeURIComponent(i[1]).replace(/\+/g, " ");
            ...
            var n, a = new CustomEvent("consent.onetrust", {
                detail: t
            });
    ...
    function ae() {
        ...
        this.iabType = null, this.iabTypeAdded = !0, this.crossOrigin = null, this.isAmp = !1, this.domainId = "", this.isReset = !1, this.isPreview = !1, this.geoFromUrl = "", this.addBannerSDKScript = function(e) {
            ...
            }), c.crossOrigin = ee.stubScriptElement.getAttribute("crossorigin") || null, c.isAmp = !!ee.stubScriptElement.getAttribute("amp"), window.otStubData = {
                domainData: e,
                stubElement: o,
            ...
            if (e.__cmpCall && "IAB" === c.iabType) {
                ...
                c.executeCmpApi(r, t, function(e, t) {
                    ...
                    n.source.postMessage(a ? JSON.stringify(o) : o, n.origin)
                })
            ...
            if (e.__tcfapiCall && "IAB2" === c.iabType) {
                ...
                c.executeTcfApi(l, t, function(e, t) {
                    ...
                    n && n.source && n.source.postMessage && n.source.postMessage(a ? JSON.stringify(o) : o, "*")
                }, o)
            ...
            var o = e[0],
                ...
                a = e[2],
                i = e[3];
            "function" == typeof a && o && ("ping" === o ? c.getPingRequest(a) : c.addToQueue(o, n, a, i))
        }, this.addToQueue = function(e, t, o, n) {
            var a = window,
                i = "IAB" === c.iabType ? "__cmp" : "__tcfapi";
            a[i].a = a[i].a || [], a[i].a.push([e, t, o, n])
    ...
    var ie = new ne;
    return e.OtSDKStub = ne, e.otSdkStub = ie, e
}({});