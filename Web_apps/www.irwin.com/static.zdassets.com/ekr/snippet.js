! function(e) {
                ...
                return new h((function(t, n) {
                    e.createIframeElement().then((function(r) {
                        r.addEventListener("load", (function() {
                            ...
                            o && o.document ? (o.ACFetch = y, t(o.document)) : n(e.error())
    ...
    var T = function() {
        ...
        return t = e, (n = [{
            ...
            key: "displayWarning",
            value: function() {
                console.warn("You are loading ".concat(this.version.name, " version ").concat(this.version.sha))
            }
        }, {
            key: "getSerializedVersionQueryParam",
            value: function() {
                return "".concat("__zE_ac_version", "=").concat(this.version.name, "/").concat(this.version.sha)
            }
        }, {
            key: "getVersion",
            value: function(e) {
        ...
        return t = e, (n = [{
            ...
            value: function(e) {
                ...
                return new h((function(r, o) {
                    ...
                    n ? (i.zEACLoaded = !0, i.$zopim ? r(w.products) : r(b.products)) : y(new T(i, e).resolveComposeUrl()).then((function(e) {
                        var t = e.products;
                        i.zEACLoaded = !0, r(t)
                    })).catch((function() {
                        return o(t.error(e))
        ...
        return function(e, t) {
            ...
            value: function() {
                ...
                return new h((function(t, n) {
                    ...
                    return r ? e._isHostMapped(r) ? y("https://".concat(r, "/embeddable/zendesk_host")).then((function(e) {
    ...
    function oe(e) {
        ...
        try {
            ...
            var t = function(e) {
                    return D.isSnippetPresent(e) ? new D(e) : e.document.zendeskHost && e.document.zEQueue ? new K(e) : ee.isSnippetPresent(e) ? new ee(e) : new D(e)
                }(window),
                n = new x(t);
