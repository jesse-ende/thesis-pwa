...
######################################################
# ORA_CODE.JS - v1.80
# BUILD DATE: 19th May 2021
# COPYRIGHT ORACLE CORP 2021 [UNLESS STATED OTHERWISE]
######################################################
*/
var oraVersion = "ora_code:1.80:JS 2.6.0";
...
function s_Ping(s_PingOK) {
    ...
    var b_state = true;
    var s_block = ["file://", ".openoffice.", "americanarabchamberlasvegas.com", "eurodoctor.org", "beacoa.com", "aokai.net", "ceme.gsras.ru", "4tg.pl", "oraclepizzaparty", "s-event.cn", "igeninfo.com", "4tg.pl", "eurodoctor.co", "mynsd.info", "igeninfo.com", "mynsd.info", ".bluekai.com", "yundba.com"];
    s_PingOK = (typeof s_PingOK == "undefined" || toString(s_PingOK) == "") ? b_state : s_PingOK;
...
function s_SetOraConfig() {
    ...
    s.linkDownloadFileTypes = "7z,avi,bat,bin,brk,bz2,cpio,dll,dmg,doc,docx,dot,exe,gz,iso,jar,jnlp,mdb,mov,mobi,mp3,mp4,mpeg,mpg,mpp,msi,odg,odp,ods,odt,otg,otp,ots,ott,ova,ovf,pdf,ppt,pptx,rm,rpm,sh,smi,smil,so,swf,tar,tgz,txt,vsd,wav,wma,wmv,wrf,xls,xlsx,z,zdl,zip";
    s.linkInternalFilters = "javascript:,.oracle.,sellingpoint,.oraclecloud.,custhelp.com,java.com,taleo.net,eloqua.com,rainfocus.com,go.java,mysql.com,on24.com,bluekai.com";
...
function navTrack(sitename, language, pagearea, linklabel) {
        ...
        if (linklabel.attr("href")) {
            if (linklabel.attr("name")) {
                ...
                if (linklabel.attr("title")) {
                    ...
                    if (linklabel.find("img") && linklabel.find("img").first().attr("title")) {
                        ltxt = linklabel.find("img").first().attr("title");
                    } else {
                        if (linklabel.find("img") && linklabel.find("img").first().attr("alt")) {
                ...
                if (linklabel.href) {
                    if (linklabel.name) {
                        ...
                        if (linklabel.title) {
                            ...
                            if (linklabel.getElementsByTagName("img")[0] && linklabel.getElementsByTagName("img")[0].alt) {
                                ltxt = linklabel.getElementsByTagName("img")[0].alt;
                            } else {
                                if (linklabel.getElementsByTagName("img")[0] && linklabel.getElementsByTagName("img")[0].title) {
    ...
    linkvalue = (typeof(ltxt) != "undefined" || ltxt != "") ? (linkvalue + ":" + ltxt) : linkvalue;
...
function s_setOraLangCountryGLOBAL(sitePreFix) {
    ...
    sitePreFix = ((sitePreFix == "" || typeof(sitePreFix) == "undefined") ? "oracle.com" : sitePreFix);
...
function s_orapageName(s_pageName) {
    ...
    s_pageName = (typeof s_pageName == "undefined" || s_pageName == "") ? location.pathname.toLowerCase() : s_pageName;
    ...
    if (s_pageName.indexOf("/openworld/") == 0 && s_account[1].indexOf("oow") != -1) {
        s_pageName = s_pageName.substr(10, s_pageName.length - 10);
    }
    if (s_pageName.indexOf("/javaone/") == 0 && s_account[1].indexOf("javaone") != -1) {
...
function s_oraChannel(s_ch) {
    var ch = new Array();
    s_ch = (typeof(s_ch) == "undefined" || s_ch == "") ? location.pathname.toLowerCase() : s_ch;
    ch = s_ch.split("/");
    ch.pop();
...
function s_oraSetsiteID() {
    ...
    if (s_account[2].search("-") > 0) {
        s_siteID = s_account[1] + ":" + s_account[2].slice(0, s_account[2].search("-"));
    }
...
function s_oraRSS() {
    if (s.getQueryParam("rssid")) {
        ...
        s.eVar3 = s.getQueryParam("rssid") + ": " + ((s.pageName && s.pageName != "undefined") ? s.pageName : s.baseURL);
...
function s_oraMsgid() {
    if (s.getQueryParam("msgid")) {
        ...
        s.eVar5 = s.getQueryParam("msgid") + ": " + ((s.pageName && s.pageName != "undefined") ? s.pageName : s.baseURL);
...
function s_oraPaidSearch() {
    if (s.getQueryParam("sckw")) {
        ...
        s.eVar7 = s.getQueryParam("sckw") + ": " + ((s.pageName && s.pageName != "undefined") ? s.pageName : s.baseURL);
        ...
        if (dlinkObject) {
            ...
            if (downloadText.indexOf("img") > -1) {
                if (downloadText.indexOf("name") > -1) {
                    downloadText = downloadText.substring(downloadText.indexOf('name="') + 6, downloadText.length);
                    downloadText = downloadText.substring(0, downloadText.indexOf('"'));
                } else {
                    if (downloadText.indexOf("alt") > -1) {
                        downloadText = downloadText.substring(downloadText.indexOf('alt="') + 5, downloadText.length);
                        downloadText = downloadText.substring(0, downloadText.indexOf('"'));
                    } else {
            ...
            s.eVar15 = dlinkObject.href.substring(dlinkObject.href.lastIndexOf("/") + 1, dlinkObject.href.length);
...
function s_oraCampaign() {
    if (s.getQueryParam("pcode") || s.getQueryParam("src") || s.getQueryParam("act")) {
        s.eVar46 = (s.getQueryParam("pcode")) ? s.getQueryParam("pcode") : "";
        s.eVar46 = (s.getQueryParam("Src")) ? s.eVar46 + ":" + s.getQueryParam("Src") : s.eVar46;
        if (!s.getQueryParam("Src")) {
            s.eVar46 = (s.getQueryParam("src")) ? s.eVar46 + ":" + s.getQueryParam("src") : s.eVar46;
        }
        s.eVar46 = (s.getQueryParam("Act")) ? s.eVar46 + ":" + s.getQueryParam("Act") : s.eVar46;
...
function s_oraLinkHandling() {
    ...
    if (eLink) {
        if (s.pageName.indexOf("Dialogue Thanks Page") > -1) {
            s.manageVars("clearVars", "pageName,prop8,eVar1,eVar30,eVar31,eVar40,eVar41,eVar42", 2);
            s.linkTrackVars = "pageName,prop8,eVar1,eVar30,eVar31,eVar40,eVar41,eVar42,events";
            var eventsValue = "event34";
            var linkTrackCookie = s.c_r("ORA_EMKT_LPCLKTRK");
            var setE33 = (linkTrackCookie == "" || s.eVar1 == "" || typeof(s.eVar1) == "undefined") ? -1 : true;
            ...
            if (eLinkText.indexOf("img") > -1) {
                if (eLinkText.indexOf("name") > -1) {
                    eLinkText = eLinkText.substring(eLinkText.indexOf('name="') + 6, eLinkText.length);
                    eLinkText = eLinkText.substring(0, eLinkText.indexOf('"'));
                } else {
                    if (eLinkText.indexOf("alt") > -1) {
                        eLinkText = eLinkText.substring(eLinkText.indexOf('alt="') + 5, eLinkText.length);
                        eLinkText = eLinkText.substring(0, eLinkText.indexOf('"'));
                    } else {
...
function s_setGUID() {
    ...
    if (window.aConsent[0] != 1) {
        ...
        if (s_www_mrkt.version != -1) {
            ...
            s.eVar54 = (window.aConsent[0] == 3 || window.aConsent[0] == 0) ? s_www_mrkt.guid : "NotSent";
        } else {
            var s_user_info = s_getUserInfo();
            if (s_user_info.version != -1) {
                s.prop67 = s.prop67.replace("NoCookie", "ucm_info");
                s.prop55 = (s_user_info.username.toLowerCase().indexOf("@oracle") > 0) ? "O" : "P";
                s.eVar54 = (window.aConsent[0] == 3 || window.aConsent[0] == 0) ? s_user_info.guid : "NotSent";
            }
        }
    }
    s.prop54 = "D=v54";
    if (s.getQueryParam("s_debug")) {
        console.log("debug:TRUSTe consent level=" + window.aConsent[0] + " :Source=" + window.aConsent[1]);
        console.log("debug:s.prop54 = " + s.eVar54 + " :s.prop55 = " + s.prop55 + " :s.prop67 = " + s.prop67);
    }
}
...
function sani(saniMe) {
    ...
    var goodChar = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ @";
    if (sMe != "NoData") {
        var al = sMe.length;
        for (i = 0; i < al; i++) {
...
function AppMeasurement(r) {
    ...
    a.foreachVar = function(c, b) {
        ...
        e = f = "";
        if (a.lightProfileID) {
            d = a.P, (h = a.lightTrackVars) && (h = "," + h + "," + a.na.join(",") + ",");
        } else {
            d = a.g;
            if (a.pe || a.linkType) {
                h = a.linkTrackVars, f = a.linkTrackEvents, a.pe && (e = a.pe.substring(0, 1).toUpperCase() + a.pe.substring(1), a[e] && (h = a[e].Nb, f = a[e].Mb));
            }
            h && (h = "," + h + "," + a.H.join(",") + ",");
            f && h && (h += ",events,");
        }
        ...
        for (f = 0; f < d.length; f++) {
            e = d[f], (g = a[e]) && (!h || 0 <= h.indexOf("," + e + ",")) && (!b || 0 <= b.indexOf("," + e + ",")) && c(e, g);
        }
    };
            ...
            for (h in b) {
                if (!(Object.prototype[h] || e && h.substring(0, e.length) != e) && b[h] && (!d || 0 <= d.indexOf("," + (f ? f + "." : "") + h + ","))) {
                    ...
                    if (!k && ("" == g && (g += "&" + c + "."), l = b[h], e && (h = h.substring(e.length)), 0 < h.length)) {
                        if (k = h.indexOf("."), 0 < k) {
                            l = h.substring(0, k), k = (e ? e : "") + l + ".", m || (m = []), m.push(k), g += a.r(l, b, d, f, k);
                        } else {
    ...
    a.zb = function() {
        var c = "",
            ...
            n = e = "";
        if (a.lightProfileID) {
            b = a.P, (q = a.lightTrackVars) && (q = "," + q + "," + a.na.join(",") + ",");
        } else {
            b = a.g;
            if (a.pe || a.linkType) {
                q = a.linkTrackVars, m = a.linkTrackEvents, a.pe && (e = a.pe.substring(0, 1).toUpperCase() + a.pe.substring(1), a[e] && (q = a[e].Nb, m = a[e].Mb));
            }
            q && (q = "," + q + "," + a.H.join(",") + ",");
            m && (m = "," + m + ",", q && (q += ",events,"));
                    ...
                    case "events":
                        ...
                        if (m) {
                            for (h = g.split(","), g = "", f = 0; f < h.length; f++) {
                                l = h[f], k = l.indexOf("="), 0 <= k && (l = l.substring(0, k)), k = l.indexOf(":"), 0 <= k && (l = l.substring(0, k)), 0 <= m.indexOf("," + l + ",") && (g += (g ? "," : "") + h[f]);
                            }
                        }
                        break;
                    case "events2":
    ...
    a.Hb = function() {
        ...
        if (!f && e) {
            ...
            if (a.trackDownloadLinks && a.linkDownloadFileTypes) {
                for (l = e.toLowerCase(), g = l.indexOf("?"), h = l.indexOf("#"), 0 <= g ? 0 <= h && h < g && (g = h) : g = h, 0 <= g && (l = l.substring(0, g)), g = a.linkDownloadFileTypes.toLowerCase().split(","), h = 0; h < g.length; h++) {
        ...
        if (a.trackClickMap || a.trackInlineStats) {
            a.e = "", d && (f = a.pageName, e = 1, d = d.sourceIndex, f || (f = a.pageURL, e = 0), k.s_objectID && (b.id = k.s_objectID, d = b.type = 1), f && b && b.id && c && (a.e = "&pid=" + a.escape(f.substring(0, 255)) + (e ? "&pidt=" + e : "") + "&oid=" + a.escape(b.id.substring(0, 100)) + (b.type ? "&oidt=" + b.type : "") + "&ot=" + c + (d ? "&oi=" + d : "")));
        }
    };
    a.Ab = function() {
        var c = a.oa,
        ...
        if (a.trackClickMap || a.trackInlineStats || a.ActivityMap) {
            ...
            for (k in a.contextData) {
                k && !Object.prototype[k] && "a.activitymap." == k.substring(0, 14) && (h[k] = a.contextData[k], a.contextData[k] = "");
            }
            a.e = a.r("c", h) + (a.e ? a.e : "");
            if (c || a.e) {
                c && !a.e && (e = 1);
                ...
                if (d) {
                    ...
                    for (l in b) {
                        !Object.prototype[l] && 0 < h && 0 < b[l].length && (e += (e ? "&" : "") + a.escape(b[l].join(",")) + "=" + a.escape(l), h--);
                    }
        ...
        if (a && 255 < a.length && (b = "" + a, d = b.indexOf("?"), 0 < d && (l = b.substring(d + 1), b = b.substring(0, d), e = b.toLowerCase(), f = 0, "http://" == e.substring(0, 7) ? f += 7 : "https://" == e.substring(0, 8) && (f += 8), d = e.indexOf("/", f), 0 < d && (e = e.substring(f, d), g = b.substring(d), b = b.substring(0, d), 0 <= e.indexOf("google") ? h = ",q,ie,start,search_key,word,kw,cd," : 0 <= e.indexOf("yahoo.co") && (h = ",p,ei,"), h && l)))) {
            if ((a = l.split("&")) && 1 < a.length) {
                for (f = 0; f < a.length; f++) {
                    e = a[f], d = e.indexOf("="), 0 < d && 0 <= h.indexOf("," + e.substring(0, d) + ",") ? k += (k ? "&" : "") + e : m += (m ? "&" : "") + e;
                }
                k && m ? l = k + "&" + m : m = "";
            }
    ...
    a.t = a.track = function(c, b) {
        var d, f = new Date,
            e = "s" + Math.floor(f.getTime() / 10800000) % 10 + Math.floor(10000000000000 * Math.random()),
            g = f.getYear(),
    ...
    a.doPostbacks = function(c) {
        if ("object" == typeof c) {
            if (a.ub(c), "object" == typeof a.AudienceManagement && "function" == typeof a.AudienceManagement.isReady && a.AudienceManagement.isReady() && "function" == typeof a.AudienceManagement.passData) {
    ...
    a.Jb = function(c) {
        ...
        if (a.useForcedLinkTracking && a.K || a.A) {
            a.forcedLinkTrackingTimeout || (a.forcedLinkTrackingTimeout = 250), a.ha = setTimeout(a.ga, a.forcedLinkTrackingTimeout);
        }
    };
    a.sb = function() {
        if (a.ra() && !(a.Oa > a.O)) {
    ...
    for (m = 0; 250 >= m; m++) {
        76 > m && (a.g.push("prop" + m), a.P.push("prop" + m)), a.g.push("eVar" + m), a.P.push("eVar" + m), 6 > m && a.g.push("hier" + m), 4 > m && a.g.push("list" + m);
    }
