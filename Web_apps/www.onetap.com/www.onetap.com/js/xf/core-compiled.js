            ...
            m = function(a) {
                e = XF.ajax("post", XF.canonicalizeUrl("job.php"), {
                    ...
                    a.more && a.ids && a.ids.length ? (a.status && d("#xfAutoBlockingJobStatus").text(a.status), setTimeout(function() {
                        m(a.ids)
                    }, 0)) : (h(), a.moreAuto && setTimeout(l, 100))
                }, {
                    skipDefault: !0
                }).fail(h)
            },
        ...
        var a, b, c, f, e, g, l = !1,
            ...
            q = function(m) {
                ...
                var h = m.length,
                    ...
                    q = new Date;
                q.setHours(0, 0, 0, 0);
                b + k > e && (q.getDay(), e = p(q, 1), c = p(q, 0), f = p(q, -1), g = p(q, -6));
                for (var w = 0; w < h; w++) {
                    var n = m[w];
                    var r = d(n);
                    ...
                    var u = n.xfDynType; - 2 > y ? (y = x - (b + k), 60 > y ? "futureMoment" != u && (r.text(XF.phrase("in_a_moment")), n.xfDynType = "futureMoment") : 120 > y ? "futureMinute" != u && (r.text(XF.phrase("in_a_minute")), n.xfDynType = "futureMinute") : 3600 > y ? (x = Math.floor(y / 60), u !== "futureMinutes" + x && (r.text(XF.phrase("in_x_minutes", {
                        "{minutes}": x
                    })), n.xfDynType = "futureMinutes" + x)) : x < e ? "latertoday" != u && (r.text(XF.phrase("later_today_at_x", {
                        ...
                        "{time}": r.attr("data-time-string")
                    })) : r.text(r.attr("data-date-string"))), n.xfDynType = "future")) : 60 >= y ? "moment" !== u && (r.text(XF.phrase("a_moment_ago")), n.xfDynType = "moment") : 120 >= y ? "minute" !== u && (r.text(XF.phrase("one_minute_ago")), n.xfDynType = "minute") : 3600 > y ? (x = Math.floor(y / 60), u !== "minutes" + x && (r.text(XF.phrase("x_minutes_ago", {
                        "{minutes}": x
                ...
                if (b) {
                    ...
                    if (!a.data("expand-check-triggered") && (a.data("expand-check-triggered", !0), a.find("img").one("load", l), h.MutationObserver)) {
                        ...
                        var p = new MutationObserver(function(b) {
                            a.hasClass("is-expanded") ? p.disconnect() : w && (k && clearTimeout(k), k = setTimeout(q, 200))
                        });
                        p.observe(this, {
                            attributes: !0,
                            childList: !0,
        ...
        show: function(a, b) {
            ...
            if (c)
                if (this.visible = !0, this.ed) {
                    ...
                    b.remove();
                    return g.getResultPositionForSelection(l, m, n, a, e)
                })
        },
    ...
    XF.Disabler = XF.Element.newHandler({
        ...
        recalculate: function(a, b) {
            ...
            e.is(":enabled") && (e.is(":checked") && !this.options.invert || this.options.invert && !e.is(":checked")) ? (d.prop("disabled", !1).removeClass("is-disabled"), f.prop("disabled", !1).removeClass("is-disabled").each(function(a, b) {
                ...
                XF.layoutChange();
                k()
            }), d.trigger("toggle:shown"), XF.layoutChange()) : a || k()) : (this.options.hide && (a ? d.hide() : d.slideUp(h, XF.layoutChange), d.trigger("toggle:hidden"), XF.layoutChange()), d.prop("disabled", !0).addClass("is-disabled"), f.prop("disabled", !0).addClass("is-disabled").trigger("control:disabled").each(function(a, b) {
                a = c(b);
                b = a.data("disabled");
...
! function(d, g, k) {
            ...
            if (a && XF.isIOS()) {
                ...
                if (e && this.menuRef.left == e[0] && this.menuRef.width == e[1]) {
                    ...
                    "fixed" == h && h != b.css("position") ? (f = {
                        ...
                        "transition-property": "none",
                        "transition-duration": "0s"
                    }, f = this.getVerticalAbsolutePosition(e, f));
    ...
    XF.ToggleClick = XF.Event.newHandler({
        ...
        hide: function(a) {
            if (this.isVisible() && !this.isTransitioning()) {
                ...
                this.$toggleParent && this.$toggleParent.removeClassTransitioned(b, this.inactiveTransitionComplete, a);
    ...
    XF.ToggleStorageDataInstance = XF.create({
        ...
        get: function(a, b, c) {
            ...
            if (!e && c[0] + c[1] < f) return delete this.dataCache[a][b], this.scheduleSync(a), null;
    ...
    XF.Tabs = XF.Element.newHandler({
        ...
        activateTab: function(a) {
            ...
            b.length && c.length ? (this.$tabs.filter("." + e).removeClass(e).attr("aria-selected", "false").trigger("tab:hidden"), this.$panes.filter("." + e).removeClass(e).attr("aria-expanded", "false").trigger("tab:hidden"), b.addClass(e).attr("aria-selected", "true").trigger("tab:shown"), c.addClass(e).attr("aria-expanded", "true").trigger("tab:shown"), XF.layoutChange(), c.data("href") && !c.data("tab-loading") && (c.data("tab-loading", !0), XF.ajax("get", c.data("href"), {}, function(a) {
                c.data("href", !1);
                if (a.html) {
