! function(e) {
    ...
    function x(e, t, i, n = !1) {
        if (t || r.a.error("Cannot call on() with no event: ", t), i || r.a.error("Cannot call on() with no task: ", i), "string" == typeof e) {
            ...
            if (n.length > 0)
                for (let e = 0; e < n.length; e++) x(n[e], t, i)
    ...
    class I {
        ...
        static call(e, t, i, n) {
            ...
            if (o.append("Origin", y.a.getOrigin()), o.append("SDK-Version", `onesignal/web/${h.a.version()}`), o.append("Content-Type", "application/json;charset=UTF-8"), n)
                for (let e of Object.keys(n)) o.append(e, n[e]);
            const s = {
    ...
    class M {
        static initialize(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                document.querySelectorAll(M.containerSelector).forEach(t => {
                    M.isInitialized(t) || M.injectMarkup(t, e)
                });
                const t = yield OneSignal.privateIsPushNotificationsEnabled(), i = yield OneSignal.internalIsOptedOut();
                document.querySelectorAll(M.subscribeSelector).forEach(n => M.initSubscribeElement(n, e, t, i)), document.querySelectorAll(M.explanationSelector).forEach(i => M.initExplanationElement(i, e, t))
            })
        }
        static injectMarkup(e, t) {
            if (t.text) {
                if (e.innerHTML = "", t.text.explanation) {
                    ...
                    Object(A.a)(t, M.explanationClass), e.appendChild(t)
                }
                if (t.text.subscribe) {
                    const t = document.createElement("button");
                    Object(A.a)(t, M.subscribeClass), e.appendChild(t)
                }
                M.markAsInitialized(e)
            } else E.a.error("CustomLink: required property 'text' is missing in the config")
        }
        static initSubscribeElement(e, t, i, n) {
            t.text && t.text.subscribe && (i || (e.textContent = t.text.subscribe)), t.text && t.text.unsubscribe && i && (e.textContent = t.text.unsubscribe), M.setResetClass(e), M.setStateClass(e, i), M.setStyleClass(e, t), M.setSizeClass(e, t), M.setCustomColors(e, t), !0 !== t.unsubscribeEnabled && Object(A.a)(e, "hide"), e.setAttribute(M.subscriptionStateAttribute, i.toString()), e.setAttribute(M.optedOutAttribute, n.toString()), M.isInitialized(e) || (e.addEventListener("click", () => {
                E.a.info("CustomLink: subscribe clicked"), M.handleClick(e)
            }), M.markAsInitialized(e))
        }
        static handleClick(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = "true" === e.getAttribute(M.subscriptionStateAttribute),
                    i = "true" === e.getAttribute(M.optedOutAttribute);
                if (t) {
        ...
        static initExplanationElement(e, t, i) {
            t.text && t.text.explanation && (e.textContent = t.text.explanation), M.setResetClass(e), M.setStateClass(e, i), M.setSizeClass(e, t), !0 !== t.unsubscribeEnabled && Object(A.a)(e, "hide")
        }
        ...
        static setStateClass(e, t) {
            ...
            Object(A.o)(e, i) && Object(A.v)(e, i), Object(A.o)(e, n) || Object(A.a)(e, n)
        }
        static setStyleClass(e, t) {
            if (!t || !t.style) return;
            const i = t.style;
            Object(A.o)(e, i) || Object(A.a)(e, i)
        }
        ...
        static setResetClass(e) {
            const t = M.resetClass;
            Object(A.o)(e, t) || Object(A.a)(e, t)
        }
        static markAsInitialized(e) {
            e.setAttribute(M.initializedAttribute, "true")
        }
        static isInitialized(e) {
            return "true" === e.getAttribute(M.initializedAttribute)
        }
    }
    M.initializedAttribute = "data-cl-initialized", M.subscriptionStateAttribute = "data-cl-state", M.optedOutAttribute = "data-cl-optedout", M.containerClass = "onesignal-customlink-container", M.containerSelector = `.${M.containerClass}`, M.subscribeClass = "onesignal-customlink-subscribe", M.subscribeSelector = `.${M.subscribeClass}`, M.explanationClass = "onesignal-customlink-explanation", M.explanationSelector = `.${M.explanationClass}`, M.resetClass = "onesignal-reset";
    var N, k, x = i(8),
        _ = i(22);
    ! function(e) {
    ...
    class j {
        static isCategorySlidedownConfigured(e) {
            if (!e) return !1;
            const t = j.getFirstSlidedownPromptOptionsWithType(e, N.Category);
    ...
    class D {
        ...
        getReportedNotificationPermission(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (g.a.safari) return D.getSafariNotificationPermission(e);
                if (x.b.isUsingSubscriptionWorkaround()) return yield this.getOneSignalSubdomainNotificationPermission(e); {
        ...
        isPermissionEnvironmentAmbiguous(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = x.b.redetectBrowserUserAgent();
                return !t.safari && !t.firefox && e === k.Denied && (this.isCurrentFrameContextCrossOrigin() || (yield y.a.isFrameContextInsecure()) || x.b.isUsingSubscriptionWorkaround())
            })
        }
    ...
    class B {
        ...
        static setStoredPermission(e) {
            localStorage.setItem(D.STORED_PERMISSION_KEY, e)
        }
        static getStoredPermission() {
            switch (localStorage.getItem(D.STORED_PERMISSION_KEY) || "default") {
                case "granted":
                    return k.Granted;
                case "denied":
                    return k.Denied;
        ...
        static setLocalPageViewCount(e) {
            localStorage.setItem(W, e.toString())
        }
        static getLocalPageViewCount() {
            return Number(localStorage.getItem(W))
        }
    }
    class V {
        static onNotificationPermissionChange() {
            V.checkAndTriggerSubscriptionChanged()
        }
        ...
        static checkAndTriggerSubscriptionChanged() {
            return Object(d.a)(this, void 0, void 0, function*() {
                x.a.logMethodCall("checkAndTriggerSubscriptionChanged");
                const e = yield OneSignal.context.subscriptionManager.getSubscriptionState(), t = yield OneSignal.privateIsPushNotificationsEnabled(), i = yield T.a.getAppState(), {
                    lastKnownPushEnabled: n
                } = i;
                (null === n || t !== n) && (E.a.info("The user's subscription state changed from " + `${null===n?"(not stored)":n} ⟶ ${e.subscribed}`), B.setIsPushNotificationsEnabled(t), i.lastKnownPushEnabled = t, yield T.a.setAppState(i), V.triggerSubscriptionChanged(t))
            })
        }
        static _onSubscriptionChanged(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                V.onSubscriptionChanged_showWelcomeNotification(e), V.onSubscriptionChanged_sendCategorySlidedownTags(e), V.onSubscriptionChanged_evaluateNotifyButtonDisplayPredicate(), V.onSubscriptionChanged_updateCustomLink()
            })
        }
        static onSubscriptionChanged_sendCategorySlidedownTags(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                j.isCategorySlidedownConfigured(n) && (yield OneSignal.context.tagManager.sendTags(!1))
            })
        }
        static onSubscriptionChanged_showWelcomeNotification(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (OneSignal.__doNotShowWelcomeNotification) E.a.debug("Not showing welcome notification because user has previously subscribed.");
                    ...
                    const {
                        deviceId: e
                    } = yield T.a.getSubscription(), {
                        appId: t
                    } = yield T.a.getAppConfig();
                    ...
                    o = _.a.decodeHtmlEntities(o), s = _.a.decodeHtmlEntities(s), n || (E.a.debug("Sending welcome notification."), C.sendNotification(t, [e], {
                        en: o
                    }, {
                        en: s
                    }, a, null, {
        ...
        static onSubscriptionChanged_updateCustomLink() {
            return Object(d.a)(this, void 0, void 0, function*() {
                OneSignal.config.userConfig.promptOptions && (yield M.initialize(OneSignal.config.userConfig.promptOptions.customlink))
            })
        }
        ...
        static fireStoredNotificationClicks(e = document.URL) {
            return Object(d.a)(this, void 0, void 0, function*() {
                function t(e) {
                    return Object(d.a)(this, void 0, void 0, function*() {
                        const t = yield T.a.getAppState();
                        t.clickedNotifications[e.url] = null, yield T.a.setAppState(t);
                        const {
                            data: i,
                            timestamp: n
                        } = e;
                ...
                const i = yield T.a.getAppState();
                if ("origin" === (yield T.a.get("Options", "notificationClickHandlerMatch"))) {
    ...
    class $ {
        ...
        static ensureBackwardsCompatibility(e) {
            $.environmentPolyfill(e), $.postmams(e), e.syncHashedEmail = $.promiseStub
        }
        static environmentPolyfill(e) {
            e.environment = {}, e.environment.getEnv = function() {
                return ""
            }, e.environment.isPopup = function() {
                return y.a.getWindowEnv() === H.a.OneSignalSubscriptionPopup
            }, e.environment.isIframe = function() {
                return y.a.getWindowEnv() === H.a.OneSignalProxyFrame
            }
        }
        static postmams(e) {
            const t = function() {
    ...
    class z extends p.a {
        constructor() {
            super("This code is not implemented yet."), Object.setPrototypeOf(this, z.prototype)
        }
    }! function(e) {
    ...
    class G {
        ...
        getDeliveryPlatform() {
            const e = x.a.redetectBrowserUserAgent();
    ...
    class K extends G {
        ...
        static createFromPushSubscription(e, t, i) {
            const n = new K(t);
            return n.appId = e, n.subscriptionState = t ? L.Subscribed : L.NotSubscribed, i && (n.subscriptionState = i), n
        }
        deserialize(e) {
            throw new z
        }
    ...
    var q, Y, J = i(17);
    (Y = q || (q = {}))[Y.Blocked = 0] = "Blocked", Y[Y.Dismissed = 1] = "Dismissed", Y[Y.Default = 2] = "Default";
    class Q extends p.a {
        constructor(e) {
            let t;
            switch (e) {
            ...
            super(t), this.reason = e, Object.setPrototypeOf(this, Q.prototype)
        }
    }
    class Z {
        isNewSubscription() {
        ...
        static deserialize(e) {
            ...
            return t.w3cP256dh = e.w3cP256dh, t.w3cAuth = e.w3cAuth, t.existingW3cPushSubscription = void 0, e.existingW3cPushSubscription ? t.existingW3cPushSubscription = Z.deserialize(e.existingW3cPushSubscription) : e.existingPushSubscription && (t.existingW3cPushSubscription = Z.deserialize(e.existingPushSubscription)), t.safariDeviceToken = e.safariDeviceToken, t.existingSafariDeviceToken = e.existingSafariDeviceToken, t
        }
    }
    var X, ee = i(13);
    ! function(e) {
    ...
    class te {
        static registerForPush() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                return yield te.internalRegisterForPush(e)
            })
        }
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (e && !t.pageViewManager.isFirstPageView()) {
                    ...
                    if (e) {
                        ...
                        yield OneSignal.context.sessionManager.upsertSession(e, t, ee.b.PageRefresh)
                ...
                switch (y.a.getWindowEnv()) {
                    ...
                    case H.a.OneSignalSubscriptionModal:
                        try {
                            ...
                            i = yield t.subscriptionManager.registerSubscription(e), t.pageViewManager.incrementPageViewCount(), yield J.a.triggerNotificationPermissionChanged(), yield V.checkAndTriggerSubscriptionChanged()
                        } catch (e) {
                            E.a.info(e)
                        }
                        break;
                    case H.a.OneSignalSubscriptionPopup:
                        ...
                        try {
                            ...
                            if (yield t.permissionManager.updateStoredPermission(), i instanceof Q) switch (i.reason) {
                                case q.Blocked:
        ...
        static getRawPushSubscriptionFromServiceWorkerRegistration(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                return t ? Z.setFromW3cSubscription(t) : null
            })
        }
        ...
        static getRawPushSubscription(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (e.browserType === X.Safari) return te.getRawPushSubscriptionForSafari(t);
                if (e.isUsingSubscriptionWorkaround) return te.getRawPushSubscriptionWhenUsingSubscriptionWorkaround();
                if (e.isBrowserAndSupportsServiceWorkers) {
                    const e = yield OneSignal.context.serviceWorkerManager.getRegistration();
                    return yield te.getRawPushSubscriptionFromServiceWorkerRegistration(e)
                }
                return null
            })
        }
    ...
    class ie {
        static getCurrentNotificationType() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (e === k.Default) return L.Default;
                if (e === k.Denied) return x.a.isUsingSubscriptionWorkaround() ? L.Default : L.NotSubscribed;
                const t = yield OneSignal.context.subscriptionManager.isAlreadyRegisteredWithOneSignal();
                if (e === k.Granted && t) {
                    return (yield OneSignal.privateIsPushNotificationsEnabled()) ? L.Subscribed : L.MutedByApi
                }
                return L.Default
            })
        }
        static getNotificationTypeFromOptIn(e) {
            return 1 == e || null == e ? L.Subscribed : L.MutedByApi
        }
        ...
        static checkAndTriggerNotificationPermissionChanged() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = yield T.a.get("Options", "notificationPermission"), t = yield OneSignal.getNotificationPermission();
                e !== t && (yield J.a.triggerNotificationPermissionChanged(), yield T.a.put("Options", {
                    key: "notificationPermission",
                    value: t
                }))
            })
        ...
        static getPromptOptionsQueryString() {
            let e = "";
            if (ie.getFullscreenPermissionMessageOptions(OneSignal.config.userConfig.promptOptions)) {
        ...
        static getPromptOptionsPostHash() {
            let e = ie.getFullscreenPermissionMessageOptions(OneSignal.config.userConfig.promptOptions);
            if (e) {
                var t = {
        ...
        static getAppId() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                return yield T.a.get("Ids", "appId")
            })
        }
        static createDeviceRecord(e, t = !1) {
            return Object(d.a)(this, void 0, void 0, function*() {
                let i;
                if (t) {
                    const e = yield te.getRawPushSubscription(OneSignal.environmentInfo, OneSignal.config.safariWebId);
                    e && (i = e)
                }
                const n = new K(i);
                return n.appId = e, n.subscriptionState = yield ie.getCurrentNotificationType(), n
            })
        }
        static getDeviceId() {
            return Object(d.a)(this, void 0, void 0, function*() {
    ...
    class re {
        constructor(e, t, i) {
            ...
            this.emitter = new se.a, this.channel = new MessageChannel, this.messagePort = null, this.isListening = !1, this.isConnected = !1, this.replies = {}
        }
        ...
        onWindowPostMessageReceived(e) {
            ...
            if (i === re.CONNECTED_MESSAGE) return this.emitter.emit("connect"), void(this.isConnected = !0);
            let s = {
                    id: t,
                    command: i,
                    data: n,
        ...
        onWindowMessagePostmanConnectReceived(e) {
            ...
            if (E.a.debug(`(Postmam) (${t}) Window postmessage for Postman connect received:`, e), this.isSafeOrigin(e.origin)) {
                ...
                i === re.HANDSHAKE_MESSAGE ? (E.a.info("(Postmam) Got our expected Postmam handshake message (and connecting...):", e.data), window.removeEventListener("message", this.onWindowMessagePostmanConnectReceived), this.messagePort = e.ports[0], this.messagePort.addEventListener("message", this.onMessageReceived.bind(this), !1), E.a.info("(Postmam) Removed previous message event listener for handshakes, replaced with main message listener."), this.messagePort.start(), this.isConnected = !0, E.a.info(`(Postmam) (${t}) Connected.`), this.message(re.CONNECTED_MESSAGE), this.emitter.emit("connect")) : E.a.info("(Postmam) Got a postmam message, but not our expected handshake:", e.data)
            }
        }
        connect() {
            E.a.info(`(Postmam) (${y.a.getWindowEnv().toString()}) Establishing a connection to ${this.sendToOrigin}.`), this.messagePort = this.channel.port1, this.messagePort.addEventListener("message", this.onMessageReceived.bind(this), !1), this.messagePort.start(), this.windowReference.postMessage({
                handshake: re.HANDSHAKE_MESSAGE
    ...
    class ae {
        ...
        onModalAccepted(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                E.a.debug("User accepted the HTTPS modal prompt.", location.origin), OneSignal._sessionInitAlreadyRunning = !1, this.dispose(), ie.triggerCustomPromptClicked("granted"), E.a.debug("Calling setSubscription(true)"), yield te.registerForPush(), yield OneSignal.setSubscription(!0)
            })
        }
        onModalRejected(e) {
            E.a.debug("User rejected the HTTPS modal prompt."), OneSignal._sessionInitAlreadyRunning = !1, this.dispose(), ie.triggerCustomPromptClicked("denied")
        }
        onModalClosing(e) {
    ...
    }(oe = ne || (ne = {})).WorkerVersion = "GetWorkerVersion", oe.Subscribe = "Subscribe", oe.SubscribeNew = "SubscribeNew", oe.AmpSubscriptionState = "amp-web-push-subscription-state", oe.AmpSubscribe = "amp-web-push-subscribe", oe.AmpUnsubscribe = "amp-web-push-unsubscribe", oe.NotificationDisplayed = "notification.displayed", oe.NotificationClicked = "notification.clicked", oe.NotificationDismissed = "notification.dismissed", oe.RedirectPage = "command.redirect", oe.SessionUpsert = "os.session.upsert", oe.SessionDeactivate = "os.session.deactivate", oe.AreYouVisible = "os.page_focused_request", oe.AreYouVisibleResponse = "os.page_focused_response", oe.SetLogging = "os.set_sw_logging";
    class le {
        constructor() {
            this.replies = {}
        }
    ...
    class de {
        ...
        broadcast(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (y.a.getWindowEnv() !== H.a.ServiceWorker) return;
        ...
        unicast(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (y.a.getWindowEnv() === H.a.ServiceWorker) {
        ...
        directPostMessageToSW(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const n = ce.getAvailableServiceWorker(i);
                n ? n.postMessage({
                    command: e,
                    payload: t
        ...
        listen() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                y.a.getWindowEnv() === H.a.ServiceWorker ? (self.addEventListener("message", this.onWorkerMessageReceivedFromPage.bind(this)), E.a.debug("[Worker Messenger] Service worker is now listening for messages.")) : yield this.listenForPage()
            })
        }
        listenForPage() {
            return Object(d.a)(this, void 0, void 0, function*() {
    ...
    class ue {
        ...
        loadIfNew(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return this.cache[t.toString()] || (this.cache[t.toString()] = ue.load(e, t)), yield this.cache[t.toString()]
            })
        }
        static load(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
    ...
    class fe {
        ...
        show() {
            return this.hidden ? new Promise(e => {
                this.state = "showing", S.a.trigger(fe.EVENTS.SHOWING, this);
                const t = this.element;
                if (t ? (this.hideClass && Object(A.v)(t, this.hideClass), this.showClass && Object(A.a)(t, this.showClass)) : E.a.error(`(show) could not find animated element with selector ${this.selector}`), 0 == this.targetTransitionEvents.length) return e(this);
                var i = setTimeout(() => {
                    E.a.debug(`Element did not completely show (state: ${this.state}).`)
                }, this.transitionCheckTimeout);
                Object(A.u)(this.element, "transitionend", (t, n) => {
                    if (t.target === this.element && Object(A.f)(this.targetTransitionEvents, t.propertyName)) return clearTimeout(i), n(), this.state = "shown", S.a.trigger(fe.EVENTS.SHOWN, this), e(this)
                }, !0)
            }) : Promise.resolve(this)
        }
        hide() {
            return this.shown ? new Promise(e => {
                this.state = "hiding", S.a.trigger(fe.EVENTS.HIDING, this);
                const t = this.element;
                if (t ? (this.showClass && Object(A.v)(t, this.showClass), this.hideClass && Object(A.a)(t, this.hideClass)) : E.a.error(`(hide) could not find animated element with selector ${this.selector}`), 0 == this.targetTransitionEvents.length) return e(this);
                Object(A.u)(this.element, "transitionend", (t, i) => {
                    var n = setTimeout(() => {
                        E.a.debug(`Element did not completely hide (state: ${this.state}).`)
                    }, this.transitionCheckTimeout);
                    if (t.target === this.element && Object(A.f)(this.targetTransitionEvents, t.propertyName)) return clearTimeout(n), i(), this.state = "hidden", S.a.trigger(fe.EVENTS.HIDDEN, this), e(this)
                }, !0)
            }) : Promise.resolve(this)
        }
        waitUntilShown() {
            return "shown" === this.state ? Promise.resolve(this) : new Promise(e => {
                Ui.emitter.once(fe.EVENTS.SHOWN, t => {
        ...
        waitUntilHidden() {
            return "hidden" === this.state ? Promise.resolve(this) : new Promise(e => {
                Ui.emitter.once(fe.EVENTS.HIDDEN, t => {
                    if (t === this) return e(this)
                })
            })
        }
    ...
    class Se extends fe {
        ...
        activate() {
            return this.inactive && this.shown ? new Promise(e => {
                this.activeState = "activating", S.a.trigger(Se.EVENTS.ACTIVATING, this);
                const t = this.element;
                if (t ? (this.inactiveClass && Object(A.v)(t, this.inactiveClass), this.activeClass && Object(A.a)(t, this.activeClass)) : E.a.error("Could not find active animated element"), !this.shown) return E.a.debug("Ending activate() transition (alternative)."), this.activeState = "active", S.a.trigger(Se.EVENTS.ACTIVE, this), e(this);
                ...
                Object(A.u)(this.element, "transitionend", (t, n) => {
                    if (t.target === this.element && Object(A.f)(this.targetTransitionEvents, t.propertyName)) return clearTimeout(i), n(), this.activeState = "active", S.a.trigger(Se.EVENTS.ACTIVE, this), e(this)
                }, !0)
            }) : Promise.resolve(this)
        }
        inactivate() {
            return this.active ? new Promise(e => {
                this.activeState = "inactivating", S.a.trigger(Se.EVENTS.INACTIVATING, this);
                const t = this.element;
                if (t ? (this.activeClass && Object(A.v)(t, this.activeClass), this.inactiveClass && Object(A.a)(t, this.inactiveClass)) : E.a.error("Could not find active animated element"), !this.shown) return this.activeState = "inactive", S.a.trigger(Se.EVENTS.INACTIVE, this), e(this);
                if (0 == this.targetTransitionEvents.length) return e(this);
                var i = setTimeout(() => {
                    E.a.debug(`Element did not completely inactivate (state: ${this.state}, activeState: ${this.activeState}).`)
                }, this.transitionCheckTimeout);
                Object(A.u)(this.element, "transitionend", (t, n) => {
                    if (t.target === this.element && Object(A.f)(this.targetTransitionEvents, t.propertyName)) return clearTimeout(i), n(), this.activeState = "inactive", S.a.trigger(Se.EVENTS.INACTIVE, this), e(this)
                }, !0)
            }) : Promise.resolve(this)
        }
        waitUntilActive() {
            return this.active ? Promise.resolve(this) : new Promise(e => {
                Ui.emitter.once(Se.EVENTS.ACTIVE, t => {
                    if (t === this) return e(this)
                })
            })
        }
        waitUntilInactive() {
            return this.inactive ? Promise.resolve(this) : new Promise(e => {
                Ui.emitter.once(Se.EVENTS.INACTIVE, t => {
                    if (t === this) return e(this)
                })
            })
        }
        static get EVENTS() {
            return Object.assign(Object.assign({}, fe.EVENTS), {
    ...
    class Oe extends fe {
        ...
        display(e, t, i = 0) {
            return E.a.debug(`Calling %cdisplay(${e}, ${t}, ${i}).`, Object(A.k)("code")), (this.shown ? this.hide() : Object(A.t)()).then(() => {
                this.content = Object(A.g)(t), this.contentType = e
            }).then(() => this.show()).then(() => Object(A.i)(i)).then(() => this.hide()).then(() => {
                this.content = this.getTipForState(), this.contentType = "tip"
            })
        }
        getTipForState() {
            return this.bell.state === _e.STATES.UNSUBSCRIBED ? this.bell.options.text["tip.state.unsubscribed"] : this.bell.state === _e.STATES.SUBSCRIBED ? this.bell.options.text["tip.state.subscribed"] : this.bell.state === _e.STATES.BLOCKED ? this.bell.options.text["tip.state.blocked"] : ""
        }
        enqueue(e) {
            return this.queued.push(Object(A.g)(e)), new Promise(e => {
    ...
    class ye extends Se {
        ...
        onHovering() {
            (v.isEmpty(this.events.mouse) || "out" === v.getLast(this.events.mouse)) && S.a.trigger(_e.EVENTS.HOVERING), v.put(this.events.mouse, "over")
        }
        onHovered() {
            v.put(this.events.mouse, "out"), S.a.trigger(_e.EVENTS.HOVERED)
        }
        onTap() {
        ...
        onClick() {
            if (S.a.trigger(_e.EVENTS.BELL_CLICK), S.a.trigger(_e.EVENTS.LAUNCHER_CLICK), !this.bell.message.shown || this.bell.message.contentType != Oe.TYPES.MESSAGE) {
                ...
                return this.bell.unsubscribed ? e ? this.bell.launcher.activateIfInactive().then(() => {
                ...
                }) : (Ui.registerForPushNotifications(), this.bell._ignoreSubscriptionState = !0, Ui.emitter.once(Ui.EVENTS.SUBSCRIPTION_CHANGED, () => {
                    this.bell.message.display(Oe.TYPES.MESSAGE, this.bell.options.text["message.action.subscribed"], Oe.TIMEOUT).then(() => {
                    ...
                    this.bell.showDialogProcedure()
                }) : this.bell.blocked && (Object(A.q)() ? Ui.registerForPushNotifications() : this.bell.launcher.activateIfInactive().then(() => {
                    this.bell.showDialogProcedure()
                })), this.bell.message.hide()
            }
        }
        pulse() {
            Object(A.w)(".pulse-ring"), this.element && Object(A.b)(this.element, "beforeend", '<div class="pulse-ring"></div>'), this.bell.setCustomColorsIfSpecified()
        }
    }
    class we extends fe {
        constructor(e) {
        ...
        updateBellLauncherDialogBody() {
            return OneSignal.getSubscription().then(e => {
                this.nestedContentSelector && Object(A.e)(this.nestedContentSelector);
                let t = "Nothing to show.";
                var i = "";
                if (this.bell.options.showCredit && (i = '<div class="divider"></div><div class="kickback">Powered by <a href="https://onesignal.com" class="kickback" target="_blank">OneSignal</a></div>'), this.bell.state === _e.STATES.SUBSCRIBED && !0 === e || this.bell.state === _e.STATES.UNSUBSCRIBED && !1 === e) {
                    let e = "",
                        n = Object(A.m)(this.notificationIcons);
                ...
                this.nestedContentSelector && Object(A.b)(this.nestedContentSelector, "beforeend", t), this.subscribeButton && this.subscribeButton.addEventListener("click", () => {
                    OneSignal.__doNotShowWelcomeNotification = !1, S.a.trigger(_e.EVENTS.SUBSCRIBE_CLICK)
                }), this.unsubscribeButton && this.unsubscribeButton.addEventListener("click", () => S.a.trigger(_e.EVENTS.UNSUBSCRIBE_CLICK)), this.bell.setCustomColorsIfSpecified()
            })
        }
    }
    class Ee extends Se {
        ...
        resize(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if ("small" === e && Object(A.o)(this.element, "onesignal-bell-launcher-sm") || "medium" === e && Object(A.o)(this.element, "onesignal-bell-launcher-md") || "large" === e && Object(A.o)(this.element, "onesignal-bell-launcher-lg")) return Promise.resolve(this);
                if (Object(A.v)(this.element, "onesignal-bell-launcher-sm"), Object(A.v)(this.element, "onesignal-bell-launcher-md"), Object(A.v)(this.element, "onesignal-bell-launcher-lg"), "small" === e) Object(A.a)(this.element, "onesignal-bell-launcher-sm");
                else if ("medium" === e) Object(A.a)(this.element, "onesignal-bell-launcher-md");
                else {
                    if ("large" !== e) throw new Error("Invalid OneSignal bell size " + e);
                    Object(A.a)(this.element, "onesignal-bell-launcher-lg")
                }
                return this.shown ? yield new Promise(e => {
                    ...
                    Object(A.u)(this.element, "transitionend", (i, n) => {
                        if (i.target === this.element && Object(A.f)(this.targetTransitionEvents, i.propertyName)) return clearTimeout(t), n(), e(this)
                    }, !0)
                }): this
            })
        }
        activateIfInactive() {
            return this.inactive ? (this.wasInactive = !0, this.activate()) : Object(A.t)()
        }
        inactivateIfWasInactive() {
            return this.wasInactive ? (this.wasInactive = !1, this.inactivate()) : Object(A.t)()
        }
        clearIfWasInactive() {
            this.wasInactive = !1
        }
    ...
    class Ie {
        ...
        static setItem(e, t, i) {
            if (!Ie.isLocalStorageSupported()) return;
        ...
        static getItem(e) {
            if (!Ie.isLocalStorageSupported()) return null;
    ...
    const Pe = {
            [ge.Push]: he.PromptDismissCount,
            [ge.NonPush]: he.NonPushPromptsDismissCount
        },
        Ce = {
            [ge.Push]: pe.OneSignalNotificationPrompt,
            [ge.NonPush]: pe.OneSignalNonPushPrompt
        };
    class Te {
        static markPromptDismissedWithType(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const t = Pe[e],
                    i = Ce[e];
                let n = yield T.a.get("Options", t);
                n || (n = 0), Object(A.q)() || (n += 1);
                let o = 3;
                2 == n ? o = 7 : n > 2 && (o = 30), E.a.debug(`(${y.a.getWindowEnv().toString()}) OneSignal: User dismissed the ${e} ` + `notification prompt; reprompt after ${o} days.`), yield T.a.put("Options", {
                    key: t,
                    value: n
                });
                const s = 24 * o * 60;
                return Ie.setItem(i, "dismissed", s)
            })
        }
        static wasPromptOfTypeDismissed(e) {
            switch (e) {
                case ge.Push:
                    return "dismissed" === Ie.getItem(pe.OneSignalNotificationPrompt);
                case ge.NonPush:
                    return "dismissed" === Ie.getItem(pe.OneSignalNonPushPrompt)
            }
            return !1
        }
    }
    var Ae, Me, Ne, ke, xe = '<svg class="onesignal-bell-svg" xmlns="http://www.w3.org/2000/svg" width="99.7" height="99.7" viewBox="0 0 99.7 99.7"><circle class="background" cx="49.9" cy="49.9" r="49.9"/><path class="foreground" d="M50.1 66.2H27.7s-2-.2-2-2.1c0-1.9 1.7-2 1.7-2s6.7-3.2 6.7-5.5S33 52.7 33 43.3s6-16.6 13.2-16.6c0 0 1-2.4 3.9-2.4 2.8 0 3.8 2.4 3.8 2.4 7.2 0 13.2 7.2 13.2 16.6s-1 11-1 13.3c0 2.3 6.7 5.5 6.7 5.5s1.7.1 1.7 2c0 1.8-2.1 2.1-2.1 2.1H50.1zm-7.2 2.3h14.5s-1 6.3-7.2 6.3-7.3-6.3-7.3-6.3z"/><ellipse class="stroke" cx="49.9" cy="49.9" rx="37.4" ry="36.9"/></svg>';
    class _e {
        constructor(e, t) {
            this.state = _e.STATES.UNINITIALIZED, this._ignoreSubscriptionState = !1, this.hovering = !1, this.initialized = !1, this.DEFAULT_SIZE = "medium", this.DEFAULT_POSITION = "bottom-right", this.DEFAULT_THEME = "default", this.options = {
                enable: e.enable || !1,
                ...
                colors: e.colors,
                offset: e.offset
            }, t && (this._launcher = t), this.options.enable && (this.validateOptions(this.options), this.state = _e.STATES.UNINITIALIZED, this._ignoreSubscriptionState = !1, this.installEventHooks(), this.updateState())
        }
        static get EVENTS() {
            return {
        ...
        validateOptions(e) {
            if (!e.size || !Object(A.f)(["small", "medium", "large"], e.size)) throw new Error(`Invalid size ${e.size} for notify button. Choose among 'small', 'medium', or 'large'.`);
            if (!e.position || !Object(A.f)(["bottom-left", "bottom-right"], e.position)) throw new Error(`Invalid position ${e.position} for notify button. Choose either 'bottom-left', or 'bottom-right'.`);
            if (!e.theme || !Object(A.f)(["default", "inverse"], e.theme)) throw new Error(`Invalid theme ${e.theme} for notify button. Choose either 'default', or 'inverse'.`);
        ...
        installEventHooks() {
            Ui.emitter.on(_e.EVENTS.SUBSCRIBE_CLICK, () => {
                this.dialog.subscribeButton.disabled = !0, this._ignoreSubscriptionState = !0, Ui.setSubscription(!0).then(() => (this.dialog.subscribeButton.disabled = !1, this.dialog.hide())).then(() => this.message.display(Oe.TYPES.MESSAGE, this.options.text["message.action.resubscribed"], Oe.TIMEOUT)).then(() => (this._ignoreSubscriptionState = !1, this.launcher.clearIfWasInactive(), this.launcher.inactivate())).then(() => this.updateState())
            }), Ui.emitter.on(_e.EVENTS.UNSUBSCRIBE_CLICK, () => {
                this.dialog.unsubscribeButton.disabled = !0, Ui.setSubscription(!1).then(() => (this.dialog.unsubscribeButton.disabled = !1, this.dialog.hide())).then(() => (this.launcher.clearIfWasInactive(), this.launcher.activate())).then(() => this.message.display(Oe.TYPES.MESSAGE, this.options.text["message.action.unsubscribed"], Oe.TIMEOUT)).then(() => this.updateState())
            }), Ui.emitter.on(_e.EVENTS.HOVERING, () => {
                this.hovering = !0, this.launcher.activateIfInactive(), this.message.shown || this.dialog.shown ? this.hovering = !1 : this.message.contentType !== Oe.TYPES.MESSAGE ? new Promise(e => {
                    if (this.message.queued.length > 0) return this.message.dequeue().then(t => {
                        this.message.content = t, this.message.contentType = Oe.TYPES.QUEUED, e()
                    });
                    this.message.content = Object(A.g)(this.message.getTipForState()), this.message.contentType = Oe.TYPES.TIP, e()
                }).then(() => this.message.show()).then(() => {
                    this.hovering = !1
                }) : this.hovering = !1
            }), Ui.emitter.on(_e.EVENTS.HOVERED, () => {
                this.message.contentType !== Oe.TYPES.MESSAGE && this.dialog.hidden && (this.hovering && (this.hovering = !1, this.message.waitUntilShown().then(() => Object(A.i)(Oe.TIMEOUT)).then(() => this.message.hide()).then(() => {
            ...
            }), Ui.emitter.on(Ui.EVENTS.SUBSCRIPTION_CHANGED, e => Object(d.a)(this, void 0, void 0, function*() {
                ...
                Ui.getNotificationPermission(t => {
                    let i;
                    i = e ? _e.STATES.SUBSCRIBED : t === k.Denied ? _e.STATES.BLOCKED : _e.STATES.UNSUBSCRIBED, this.setState(i, this._ignoreSubscriptionState)
                })
            })), Ui.emitter.on(_e.EVENTS.STATE_CHANGED, e => {
                this.launcher.element && (e.to === _e.STATES.SUBSCRIBED ? this.launcher.inactivate() : (e.to === _e.STATES.UNSUBSCRIBED || _e.STATES.BLOCKED) && this.launcher.activate())
            }), Ui.emitter.on(Ui.EVENTS.NATIVE_PROMPT_PERMISSIONCHANGED, () => {
                this.updateState()
            })
        }
        addDefaultClasses() {
            const e = this.container;
            if ("bottom-left" === this.options.position) e && Object(A.a)(e, "onesignal-bell-container-bottom-left"), Object(A.a)(this.launcher.selector, "onesignal-bell-launcher-bottom-left");
            else {
                if ("bottom-right" !== this.options.position) throw new Error("Invalid OneSignal notify button position " + this.options.position);
                e && Object(A.a)(e, "onesignal-bell-container-bottom-right"), Object(A.a)(this.launcher.selector, "onesignal-bell-launcher-bottom-right")
            }
            if ("default" === this.options.theme) Object(A.a)(this.launcher.selector, "onesignal-bell-launcher-theme-default");
            else {
                if ("inverse" !== this.options.theme) throw new Error("Invalid OneSignal notify button theme " + this.options.theme);
                Object(A.a)(this.launcher.selector, "onesignal-bell-launcher-theme-inverse")
            }
        }
        create() {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (!this.options.enable) return;
                if (0 !== (yield Ui.context.dynamicResourceLoader.loadSdkStylesheet())) return void E.a.debug("Not showing notify button because styles failed to load.");
                this.container && Object(A.w)("#onesignal-bell-container"), Object(A.b)("body", "beforeend", '<div id="onesignal-bell-container" class="onesignal-bell-container onesignal-reset"></div>'), this.container && Object(A.b)(this.container, "beforeend", '<div id="onesignal-bell-launcher" class="onesignal-bell-launcher"></div>'), Object(A.b)(this.launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-button"></div>'), Object(A.b)(this.launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-badge"></div>'), Object(A.b)(this.launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-message"></div>'), Object(A.b)(this.message.selector, "beforeend", '<div class="onesignal-bell-launcher-message-body"></div>'), Object(A.b)(this.launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-dialog"></div>'), Object(A.b)(this.dialog.selector, "beforeend", '<div class="onesignal-bell-launcher-dialog-body"></div>'), Object(A.b)(this.button.selector, "beforeend", xe);
                const e = yield Ui.isPushNotificationsEnabled(), t = yield Ui.getSubscription(), i = Te.wasPromptOfTypeDismissed(ge.Push);
                let n = e ? "small" : this.options.size || this.DEFAULT_SIZE;
                yield this.launcher.resize(n), this.addDefaultClasses(), this.applyOffsetIfSpecified(), this.setCustomColorsIfSpecified(), this.patchSafariSvgFilterBug(), E.a.info("Showing the notify button."), yield(e ? this.launcher.inactivate() : Object(A.t)()).then(() => Ui.getSubscription()).then(t => !e && t || null !== this.dialog.notificationIcons ? Object(A.t)() : ie.getNotificationIcons().then(e => {
                    this.dialog.notificationIcons = e
                })).then(() => Object(A.i)(this.options.showLauncherAfter || 0)).then(() => Object(A.q)() && t && !0 !== i && !e && !0 === Ui.config.userConfig.promptOptions.autoPrompt && !ie.isHttpPromptAlreadyShown() ? (E.a.debug("Not showing notify button because slidedown will be shown."), Object(A.t)()) : this.launcher.show()).then(() => Object(A.i)(this.options.showBadgeAfter || 0)).then(() => this.options.prenotify && !e && Ui._isNewVisitor ? this.message.enqueue(this.options.text["message.prenotify"]).then(() => this.badge.show()) : Object(A.t)()).then(() => this.initialized = !0)
            })
        }
        ...
        updateState() {
            Promise.all([Ui.privateIsPushNotificationsEnabled(), Ui.privateGetNotificationPermission()]).then(([e, t]) => {
                this.setState(e ? _e.STATES.SUBSCRIBED : _e.STATES.UNSUBSCRIBED), t === k.Denied && this.setState(_e.STATES.BLOCKED)
            })
        }
        setState(e, t = !1) {
            let i = this.state;
            this.state = e, i === e || t || S.a.trigger(_e.EVENTS.STATE_CHANGED, {
                from: i,
                to: e
            })
        }
        ...
        get launcher() {
            return this._launcher || (this._launcher = new Ee(this)), this._launcher
        }
        get button() {
            return this._button || (this._button = new ye(this)), this._button
        }
        get badge() {
            return this._badge || (this._badge = new ve), this._badge
        }
        get message() {
            return this._message || (this._message = new Oe(this)), this._message
        }
        get dialog() {
            return this._dialog || (this._dialog = new we(this)), this._dialog
        }
        get subscribed() {
            return this.state === _e.STATES.SUBSCRIBED
        }
        get unsubscribed() {
            return this.state === _e.STATES.UNSUBSCRIBED
        }
        get blocked() {
            return this.state === _e.STATES.BLOCKED
        }
    }
    class je {
        constructor(e, t) {
        ...
        load() {
            const e = Object.assign(Object.assign({}, ie.getPromptOptionsPostHash()), {
                promptType: "popup",
        ...
        onFinishingRegistrationRemotely(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                this.messenger && this.messenger.stopPostMessageReceive(), yield OneSignal.context.subscriptionManager.registerSubscription(t), yield V.checkAndTriggerSubscriptionChanged(), yield ie.checkAndTriggerNotificationPermissionChanged()
            })
        }
    ...
    class Ue {}(Me = Ae || (Ae = {})).HttpPermissionRequest = "HttpPermissionRequest", Me.SyncHashedEmail = "SyncHashedEmail";
    class We extends Re {
        constructor(e) {
    ...
    class Ve {
        ...
        reportEvent(e) {
            ...
            const t = {
                ...
                i = De(JSON.stringify(t)),
                n = {
                    method: "GET",
                    headers: new Headers,
                    cache: "no-cache"
                };
            return fetch(`${Ve.MIXPANEL_REPORTING_URL}/track/?data=${i}`, n)
        }
        reportEngagement(e) {
            if (!this.isEnabled()) return Promise.resolve(null);
            let t = {
            ...
            const i = De(JSON.stringify(t)),
                n = {
                    method: "GET",
                    headers: new Headers,
                    cache: "no-cache"
                };
            return fetch(`${Ve.MIXPANEL_REPORTING_URL}/engage/?data=${i}`, n)
        }
    ...
    }(ke = Ne || (Ne = {}))[ke.HttpPermissionRequest = 0] = "HttpPermissionRequest", ke[ke.SyncHashedEmail = 1] = "SyncHashedEmail";
    class Le extends p.a {
        constructor(e) {
            let t, i;
            switch (e) {
                case Ne.HttpPermissionRequest:
                    t = "The HTTP permission request has been deprecated. Please remove any custom popups from your code.", i = Ae.HttpPermissionRequest;
                    break;
                case Ne.SyncHashedEmail:
                    t = "API syncHashedEmail() has been deprecated and will be removed in a future SDK release. Please remove any usages from your code.", i = Ae.SyncHashedEmail
            }
            super(t), this.reportUsage(i), Object.setPrototypeOf(this, Le.prototype)
        }
        reportUsage(e) {
            "undefined" != typeof OneSignal && OneSignal.context && OneSignal.context.metricsManager && OneSignal.context.metricsManager.reportEvent(new We(e))
        }
    }
    class Fe {
        static internalInit() {
            return Object(d.a)(this, void 0, void 0, function*() {
                E.a.debug("Called %cinternalInit()", Object(A.k)("code")), yield OneSignal.context.serviceWorkerManager.installWorker();
                const e = OneSignal.context.sessionManager;
                OneSignal.emitter.on(OneSignal.EVENTS.SESSION_STARTED, e.sendOnSessionUpdateFromPage.bind(e)), OneSignal.context.pageViewManager.incrementPageViewCount(), "visible" === document.visibilityState ? yield Fe.sessionInit(): Fe.postponeSessionInitUntilPageIsInFocus()
            })
        }
        static postponeSessionInitUntilPageIsInFocus() {
            Object(A.u)(document, "visibilitychange", (e, t) => {
                "visible" === document.visibilityState && (t(), Fe.sessionInit())
            }, !0)
        }
        static sessionInit() {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (E.a.debug("Called %csessionInit()", Object(A.k)("code")), OneSignal._sessionInitAlreadyRunning) return void E.a.debug("Returning from sessionInit because it has already been called.");
                OneSignal._sessionInitAlreadyRunning = !0;
                try {
                    yield Fe.doInitialize()
                } catch (e) {
                    if (e instanceof f) return;
                    throw e
                }
                const e = yield OneSignal.internalIsOptedOut();
                B.setIsOptedOut(!!e), x.a.isUsingSubscriptionWorkaround() || (yield Fe.handleAutoResubscribe(e));
                const t = yield OneSignal.privateIsPushNotificationsEnabled();
                B.setIsPushNotificationsEnabled(!!t), OneSignal.config.userConfig.promptOptions.autoPrompt && !e && OneSignal.context.promptsManager.spawnAutoPrompts(), OneSignal._sessionInitAlreadyRunning = !1, yield S.a.trigger(OneSignal.EVENTS.SDK_INITIALIZED)
            })
        }
        static registerForPushNotifications(e = {}) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (e && e.modalPrompt) return OneSignal.subscriptionModalHost = new ae(OneSignal.config.appId, e), void(yield OneSignal.subscriptionModalHost.load());
                if (x.a.isUsingSubscriptionWorkaround()) return e.httpPermissionRequest ? void E.a.error(new Le(Ne.HttpPermissionRequest)) : void(yield Fe.loadSubscriptionPopup(e));
                B.getIsOptedOut() || (yield te.registerForPush())
            })
        }
        static onSdkInitialized() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = yield Fe.processExpiringSubscriptions();
        ...
        static loadSubscriptionPopup(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                OneSignal.subscriptionPopupHost = new je(OneSignal.proxyFrameHost.url, e), yield OneSignal.subscriptionPopupHost.load()
            })
        }
        static storeInitialValues() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                v.put("subscription.optedOut", i), yield T.a.put("Options", {
                    key: "isPushEnabled",
                    value: e
                }), yield T.a.put("Options", {
                    key: "notificationPermission",
                    value: t
                })
            })
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                switch (E.a.debug("Subscription is considered expiring. Current Integration:", t), t) {
                    case me.a.Secure:
                        ...
                        break;
                    case me.a.SecureProxy:
                        if (i === H.a.OneSignalProxyFrame) yield this.registerSubscriptionInProxyFrame(e);
                        else {
                            yield OneSignal.proxyFrameHost.runCommand(OneSignal.POSTMAM_COMMANDS.PROCESS_EXPIRING_SUBSCRIPTIONS)
                        }
                        break;
                    case me.a.InsecureProxy:
                        yield T.a.remove("Ids", "registrationId"), E.a.debug("Unsubscribed expiring HTTP subscription by removing registration ID.")
                }
                return !0
            })
        }
        static registerSubscriptionInProxyFrame(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = yield new Promise(t => {
                    e.workerMessenger.once(ne.SubscribeNew, e => {
                        t(be.a.deserialize(e))
                    }), e.workerMessenger.unicast(ne.SubscribeNew, e.appConfig)
                });
        ...
        static doInitialize() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = [];
                e.push(Fe.storeInitialValues()), e.push(Fe.installNativePromptPermissionChangedHook()), e.push(Fe.setWelcomeNotificationFlag()), e.push(Fe.establishServiceWorkerChannel()), e.push(Fe.showNotifyButton()), e.push(Fe.showPromptsFromWebConfigEditor());
                try {
                    yield Promise.all(e)
                } catch (e) {
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                if (h.a.isBrowser() && !OneSignal.notifyButton) {
                    ...
                    e && "function" == typeof e ? OneSignal.emitter.once(OneSignal.EVENTS.SDK_INITIALIZED, () => Object(d.a)(this, void 0, void 0, function*() {
                        !1 !== (yield Promise.resolve(OneSignal.config.userConfig.notifyButton.displayPredicate())) ? (OneSignal.notifyButton = new _e(OneSignal.config.userConfig.notifyButton), OneSignal.notifyButton.create()) : E.a.debug("Notify button display predicate returned false so not showing the notify button.")
                    })) : (OneSignal.notifyButton = new _e(OneSignal.config.userConfig.notifyButton), OneSignal.notifyButton.create())
                }
            })
        }
        static showPromptsFromWebConfigEditor() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                e.userConfig.promptOptions && (yield M.initialize(e.userConfig.promptOptions.customlink))
            })
        }
        static installNativePromptPermissionChangedHook() {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (navigator.permissions && !(g.a.firefox && Number(g.a.version) <= 45)) {
        ...
        static saveInitOptions() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                }), i && i.cors ? e.push(T.a.put("Options", {
                    key: "webhooks.cors",
                    value: !0
                })) : e.push(T.a.put("Options", {
                    key: "webhooks.cors",
                    value: !1
                })), OneSignal.config.userConfig.notificationClickHandlerMatch ? e.push(T.a.put("Options", {
                    key: "notificationClickHandlerMatch",
                    value: OneSignal.config.userConfig.notificationClickHandlerMatch
                })) : e.push(T.a.put("Options", {
                    key: "notificationClickHandlerMatch",
                    value: "exact"
                })), OneSignal.config.userConfig.notificationClickHandlerAction ? e.push(T.a.put("Options", {
        ...
        static initSaveState(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = yield ie.getAppId(), i = OneSignal.config;
                yield T.a.put("Ids", {
                    type: "appId",
                    id: t
                });
        ...
        static handleAutoResubscribe(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (E.a.info("handleAutoResubscribe", {
                    ...
                    (yield OneSignal.context.permissionManager.getNotificationPermission(OneSignal.context.appConfig.safariWebId)) == k.Granted && (yield te.registerForPush())
                }
            })
        }
        static polyfillSafariFetch() {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (g.a.safari && void 0 === window.fetch) {
                    ...
                    try {
                        yield(new ue).loadFetchPolyfill(), E.a.debug("Done loading fetch polyfill.")
                    } catch (e) {
    ...
    class He {
        ...
        setPageViewCount(e) {
            try {
                sessionStorage.setItem(He.SESSION_STORAGE_KEY_NAME, e.toString()), y.a.getWindowEnv() === H.a.OneSignalSubscriptionPopup && OneSignal.subscriptionPopup && OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.SET_SESSION_COUNT)
            } catch (e) {}
        }
    ...
    class ze extends p.a {
        constructor(e, t) {
            super("Registration of a Service Worker failed."), this.status = e, this.statusText = t, Object.setPrototypeOf(this, ze.prototype)
        }
    }
    var Ge, Ke = ze;
    ! function(e) {
    ...
    class qe {
        ...
        static getUserIdFromSubscriptionIdentifier(e, t, i) {
            return w.a.enforceAppId(e), I.post("players", {
                ...
                device_type: t,
                identifier: i,
                notification_types: L.TemporaryWebRecord
    ...
    const Qe = "sendOutcome",
        Ze = "sendUniqueOutcome";
    class Xe {
        constructor(e, t, i, n) {
        ...
        getAttribution() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Xe.getAttribution(this.config)
            })
        }
        beforeOutcomeSend() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = this.isUnique ? Ze : Qe;
                return Object(A.s)(e, this.outcomeName), this.config ? this.outcomeName ? (yield Object(A.c)(), !!(yield OneSignal.privateIsPushNotificationsEnabled()) || (E.a.warn("Reporting outcomes is supported only for subscribed users."), !1)) : (E.a.error("Outcome name is required"), !1) : (E.a.debug("Outcomes feature not supported by main application yet."), !1)
            })
        }
        getAttributedNotifsByUniqueOutcomeName() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return (yield T.a.getAll("SentUniqueOutcome")).filter(e => e.outcomeName === this.outcomeName).reduce((e, t) => {
        ...
        shouldSendUnique(e, t) {
            return e.type === Ge.Unattributed || t.length > 0
        }
        saveSentUniqueOutcome(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = this.outcomeName,
                    i = yield T.a.get("SentUniqueOutcome", t), n = yield T.a.getCurrentSession(), o = [...i ? i.notificationIds : [], ...e], s = n ? n.startTimestamp : null;
                yield T.a.put("SentUniqueOutcome", {
                    outcomeName: t,
                    notificationIds: o,
                    sentDuringSession: s
                })
        ...
        wasSentDuringSession() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = yield T.a.get("SentUniqueOutcome", this.outcomeName);
                if (!e) return !1;
                const t = yield T.a.getCurrentSession(), i = t && e.sentDuringSession === t.startTimestamp, n = !t && !!e.sentDuringSession;
                return i || n
            })
        }
        send(e) {
        ...
        static getAttribution(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (e.direct && e.direct.enabled) {
                    const e = yield T.a.getAll("NotificationClicked");
                ...
                if (e.indirect && e.indirect.enabled) {
                    const t = 60 * e.indirect.influencedTimePeriodMin * 1e3,
                        ...
                        n = yield T.a.getAll("NotificationReceived");
                    if (E.a.debug(`\tFound total of ${n.length} received notifications`), n.length > 0) {
                        ...
                        if (r.forEach(e => T.a.remove("NotificationReceived", e)), E.a.debug(`\t${r.length} received notifications will be deleted.`), s.length > 0) return {
                            type: Ge.Indirect,
                            notificationIds: s
                        }
                    }
                ...
                return e.unattributed && e.unattributed.enabled ? {
                    type: Ge.Unattributed,
                    notificationIds: []
                } : {
                    type: Ge.NotSupported,
                    notificationIds: []
                }
            })
        }
        ...
        const s = new Promise((t, s) => {
            ...
            n = self.setTimeout(() => Object(d.a)(this, void 0, void 0, function*() {
                ...
                try {
                    ...
                    Je.error("Failed to execute callback", e), s()
                }
            }), i), o = (() => {
                Je.debug("Cancel called"), self.clearTimeout(n), r || t()
            })
        });
        return o ? {
            promise: s,
            cancel: o
        } : (Je.warn("clearTimeoutHandle was not assigned."), {
            promise: s,
            cancel: et
        })
    }
    ...
    class rt {
        ...
        static downloadServerAppConfig(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return y.a.getWindowEnv() !== H.a.ServiceWorker ? yield new Promise((t, i) => {
                    rt.jsonpLib(`${y.a.getOneSignalApiUrl().toString()}/sync/${e}/web`, (e, n) => {
                        e ? i(e) : n.success ? t(n) : i(n)
                    })
                }): yield Ye.downloadServerAppConfig(e)
            })
        }
        static createUser(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
    ...
    class at {
        ...
        logout() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = yield T.a.getEmailProfile();
                if (!e.subscriptionId) return E.a.warn(new b(r.NoEmailSet)), !1;
                const {
                    deviceId: t
                } = yield T.a.getSubscription();
                if (!t) return E.a.warn(new b(r.NoDeviceId)), !1;
                const i = yield T.a.getAppConfig();
                return (yield rt.logoutEmail(i, e, t)) ? (yield T.a.setEmailProfile(new nt.a), !0) : (E.a.warn("Failed to logout email."), !1)
            })
        }
        setIdentifier(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const {
                    profileProvider: i
                } = this.secondaryChannelIdentifierUpdater, n = yield i.getProfile(), o = yield this.secondaryChannelIdentifierUpdater.setIdentifier(e, t);
                if (o) {
        ...
        updatePushPlayersRelationToEmailPlayer(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const {
                    deviceId: i
                } = yield T.a.getSubscription(), n = i, o = !!!e.subscriptionId || e.subscriptionId !== t.subscriptionId, s = !e.identifier || t.identifier !== e.identifier;
                if (i && n && (o || s)) {
                    const e = yield OneSignal.database.getExternalUserIdAuthHash(), n = yield T.a.getAppConfig();
                    yield rt.updatePlayer(n.appId, i, {
                        parent_player_id: t.subscriptionId,
                        email: t.identifier,
    ...
    class ct {
        static addExternalUserIdToDeviceRecord(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = yield T.a.getExternalUserId();
                if (!t) return;
                e.externalUserId = t;
                const i = yield T.a.getExternalUserIdAuthHash();
    ...
    class dt {
        ...
        setIdentifier(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const i = yield T.a.getAppConfig(), n = yield this.profileProvider.getProfile(), o = this.profileProvider.newProfile(n.subscriptionId, e, t);
                if (n.subscriptionId) yield rt.updatePlayer(i.appId, n.subscriptionId, {
                    identifier: e,
                    ...
                    const {
                        deviceId: e
                    } = yield T.a.getSubscription(), t = new lt(this.profileProvider.deviceType, o.identifier, o.identifierAuthHash, e);
                    t.appId = i.appId, yield ct.addExternalUserIdToDeviceRecord(t), o.subscriptionId = yield rt.createUser(t)
                }
                return o.subscriptionId && (yield this.profileProvider.setProfile(o)), o.subscriptionId
            })
        }
    }
    class ut {
        ...
        sendTags(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = yield this.profileProvider.getSubscriptionId(), {
                    appId: i
                } = yield T.a.getAppConfig(), n = (yield this.profileProvider.getProfile()).identifierAuthHash, o = {
                    tags: e,
                    identifier_auth_hash: n
                };
                yield rt.updatePlayer(i, t, o)
            })
        }
    }
    class gt {
    ...
    class ht {
        ...
        sendOnFocus(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const i = {
                    app_id: (yield T.a.getAppConfig()).appId,
                    type: 1,
                    state: "ping",
                    active_time: e,
    ...
    class pt {
        ...
        sendOnSession() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const t = new lt(this.profileProvider.deviceType, e.identifier, e.identifierAuthHash),
                    i = yield T.a.getAppConfig();
                t.appId = i.appId;
    ...
    class bt extends mt {
        constructor() {
            super(...arguments), this.deviceType = F.Email
        }
        newProfile(e, t, i) {
            return new nt.a(e, t, i)
        }
        getProfile() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield T.a.getEmailProfile()
            })
        }
        setProfile(e) {
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                yield T.a.setEmailProfile(e), yield t.setProfile.call(this, e)
            })
        }
    }
    var ft, St, vt, Ot, yt = i(19);
    class wt extends mt {
        constructor() {
            super(...arguments), this.deviceType = F.SMS
        }
        newProfile(e, t, i) {
            return new yt.a(e, t, i)
        }
        getProfile() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield T.a.getSMSProfile()
            })
        }
        setProfile(e) {
            const t = Object.create(null, {
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                yield T.a.setSMSProfile(e), yield t.setProfile.call(this, e)
            })
        }
    }
    class Et {
        ...
        logout() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return (yield T.a.getSMSProfile()).subscriptionId ? (yield T.a.setSMSProfile(new yt.a), !0) : (E.a.warn(new b(r.NoSMSSet)), !1)
            })
        }
        setIdentifier(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield this.secondaryChannelIdentifierUpdater.setIdentifier(e, t)
            })
        }
        onSession() {
            return Object(d.a)(this, void 0, void 0, function*() {
    ...
    class It {
        constructor() {
            this.synchronizer = new it;
            const e = new bt,
                t = new at(new dt(e), new gt(e), new ut(e), new pt(e), new ht(e));
            this.email = t, this.synchronizer.registerChannel(t);
            const i = new wt,
                n = new Et(new dt(i), new gt(i), new ut(i), new pt(i), new ht(i));
    ...
    class Pt {
        static getAlternatingServiceWorkerHref(e, t, i) {
            let n;
            return n = e === ft.WorkerA ? t.workerBPath.getFullPath() : t.workerAPath.getFullPath(), Pt.appendServiceWorkerParams(n, i)
        }
        static getPossibleServiceWorkerHrefs(e, t) {
            return [e.workerAPath.getFullPath(), e.workerBPath.getFullPath()].map(e => Pt.appendServiceWorkerParams(e, t))
        }
        static appendServiceWorkerParams(e, t) {
            return `${new URL(e,x.a.getBaseUrl()).href}?${w.b.encodeHashAsUriComponent({appId:t})}`
        }
        static upsertSession(e, t, i, n, o, s) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (!n) return void Je.error("No deviceId provided for new session.");
                if (!i.app_id) return void Je.error("No appId provided for new session.");
                const r = yield T.a.getCurrentSession();
                if (!r) {
                    const e = i.app_id,
                        t = Object(ee.d)({
                            deviceId: n,
                        ...
                        s = yield T.a.getLastNotificationClicked(e);
                    return s && (t.notificationId = s.notificationId), yield T.a.upsertSession(t), void(yield Pt.sendOnSessionCallIfNecessary(o, i, n, t))
                }
                if (r.status === ee.c.Active) return void Je.debug("Session already active", r);
                if (!r.lastDeactivatedTimestamp) return void Je.debug("Session is in invalid state", r);
                const a = (new Date).getTime();
                if (Pt.timeInSecondsBetweenTimestamps(a, r.lastDeactivatedTimestamp) <= e) return r.status = ee.c.Active, r.lastActivatedTimestamp = a, r.lastDeactivatedTimestamp = null, void(yield T.a.upsertSession(r));
                yield Pt.finalizeSession(r, t, s);
                const c = Object(ee.d)({
                    deviceId: n,
                    appId: i.app_id,
                    deviceType: i.device_type
                });
                yield T.a.upsertSession(c), yield Pt.sendOnSessionCallIfNecessary(o, i, n, c)
            })
        }
        static deactivateSession(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const n = yield T.a.getCurrentSession();
                if (!n) return void Je.debug("No active session found. Cannot deactivate.");
                if (n.status === ee.c.Inactive) return tt(() => Pt.finalizeSession(n, t, i), e);
                if (n.status !== ee.c.Active) return void Je.warn(`Session in invalid state ${n.status}. Cannot deactivate.`);
                const o = (new Date).getTime(),
                    s = Pt.timeInSecondsBetweenTimestamps(o, n.lastActivatedTimestamp);
                n.lastDeactivatedTimestamp = o, n.accumulatedDuration += s, n.status = ee.c.Inactive;
                const r = tt(() => Pt.finalizeSession(n, t, i), e);
                return yield T.a.upsertSession(n), r
            })
        }
        static sendOnSessionCallIfNecessary(e, t, i, n) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (e === ee.b.PlayerCreate) return;
                if (!t.identifier) {
                    const e = yield self.registration.pushManager.getSubscription();
                    if (e) {
                        const i = Z.setFromW3cSubscription(e),
                            n = new K(i).serialize();
                        t.identifier = n.identifier
                    }
                }
                const o = yield qe.updateUserSession(i, t);
                o !== i && (n.deviceId = o, yield Promise.all([T.a.setDeviceId(o), T.a.upsertSession(n), T.a.resetSentUniqueOutcomes()])), yield(new It).synchronizer.onSession()
            })
        }
        static finalizeSession(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (Je.debug("Finalize session", `started: ${new Date(e.startTimestamp)}`, `duration: ${e.accumulatedDuration}s`), t) {
                    Je.debug(`send on_focus reporting session duration -> ${e.accumulatedDuration}s`);
                    const t = yield Xe.getAttribution(i);
                    Je.debug("send on_focus with attribution", t), yield qe.sendSessionDuration(e.appId, e.deviceId, e.accumulatedDuration, e.deviceType, t), yield(new It).synchronizer.onFocus(e.accumulatedDuration)
                }
                yield Promise.all([T.a.cleanupCurrentSession(), T.a.removeAllNotificationClicked()]), Je.debug("Finalize session finished", `started: ${new Date(e.startTimestamp)}`)
            })
        }
        static timeInSecondsBetweenTimestamps(e, t) {
            return e <= t ? 0 : Math.floor((e - t) / 1e3)
        }
    }(St = ft || (ft = {})).WorkerA = "Worker A (Main)", St.WorkerB = "Worker B (Updater)", St.ThirdParty = "3rd Party", St.None = "None", St.Indeterminate = "Indeterminate";
    class Ct {
        constructor(e, t) {
        ...
        getRegistration() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield ce.getRegistration(this.config.registrationOptions.scope)
            })
        }
        getActiveState() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = yield y.a.getIntegration();
                if (e === me.a.InsecureProxy) return ft.Indeterminate;
                if (e === me.a.SecureProxy) {
                    switch (y.a.getWindowEnv()) {
                        case H.a.Host:
                        case H.a.CustomIframe:
                            const e = OneSignal.proxyFrameHost;
                            return e ? yield e.runCommand(OneSignal.POSTMAM_COMMANDS.SERVICE_WORKER_STATE): ft.Indeterminate;
                        case H.a.OneSignalSubscriptionPopup:
                            break;
                        case H.a.OneSignalSubscriptionModal:
                            throw new z
                ...
                if (!t) return ft.None;
                const i = Ct.activeSwFileName(t);
                return this.swActiveStateByFileName(i)
            })
        }
        static activeSwFileName(e) {
            const t = ce.getAvailableServiceWorker(e);
            if (!t) return null;
            const i = new URL(t.scriptURL).pathname,
                n = new $e(i).getFileName();
            if ("akam-sw.js" == n) {
                const e = new URLSearchParams(new URL(t.scriptURL).search).get("othersw");
                if (e) return E.a.debug("Found a ServiceWorker under Akamai's akam-sw.js?othersw=", e), new $e(new URL(e).pathname).getFileName()
            }
            return n
        }
        swActiveStateByFileName(e) {
            return e ? e == this.config.workerAPath.getFileName() ? ft.WorkerA : e == this.config.workerBPath.getFileName() ? ft.WorkerB : ft.ThirdParty : ft.None
        }
        getWorkerVersion() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return new Promise(e => Object(d.a)(this, void 0, void 0, function*() {
                    if (x.b.isUsingSubscriptionWorkaround()) {
                        const t = OneSignal.proxyFrameHost;
                        if (t) {
                            const i = yield t.runCommand(OneSignal.POSTMAM_COMMANDS.GET_WORKER_VERSION);
                            e(i)
                        } else e(NaN)
                    } else this.context.workerMessenger.once(ne.WorkerVersion, t => {
                        e(t)
                    }), this.context.workerMessenger.unicast(ne.WorkerVersion)
                }))
            })
        }
        shouldInstallWorker() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (OneSignal.config.subdomain && "safari" !== OneSignal.environmentInfo.browserType && y.a.getWindowEnv() === H.a.Host) return !1;
                const e = yield this.getActiveState();
                if (E.a.debug("[shouldInstallWorker] workerState", e), e === ft.None || e === ft.ThirdParty) {
        ...
        haveParamsChanged() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const n = ce.getAvailableServiceWorker(e),
                    o = Pt.getPossibleServiceWorkerHrefs(this.config, this.context.appConfig.appId);
                return null === n || void 0 === n || !n.scriptURL || -1 === o.indexOf(n.scriptURL) && (E.a.info("[changedServiceWorkerParams] ServiceWorker href changing:", {
        ...
        installWorker() {
            return Object(d.a)(this, void 0, void 0, function*() {
                (yield this.shouldInstallWorker()) && (yield this.installAlternatingWorker(), (yield this.getActiveState()) === ft.WorkerB && (yield this.installAlternatingWorker()), yield this.establishServiceWorkerChannel())
            })
        }
        establishServiceWorkerChannel() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                e.off(), e.on(ne.NotificationDisplayed, e => {
                    E.a.debug(location.origin, "Received notification display event from service worker."), S.a.trigger(OneSignal.EVENTS.NOTIFICATION_DISPLAYED, e)
                }), e.on(ne.NotificationClicked, e => Object(d.a)(this, void 0, void 0, function*() {
                    let t;
                    if (0 === (t = y.a.getWindowEnv() === H.a.OneSignalProxyFrame ? yield new Promise(e => {
                        ...
                        let t = e.url;
                        e.url || (t = location.href), yield T.a.put("NotificationOpened", {
                            url: t,
                            data: e,
                            timestamp: Date.now()
                        })
                    } else S.a.trigger(OneSignal.EVENTS.NOTIFICATION_CLICKED, e)
                })), e.on(ne.RedirectPage, e => {
                ...
                }), e.on(ne.NotificationDismissed, e => {
                    S.a.trigger(OneSignal.EVENTS.NOTIFICATION_DISMISSED, e)
                });
                const t = x.b.isHttps(),
                    i = x.b.isSafari();
                e.on(ne.AreYouVisible, n => {
                    if (t && i) {
                        const t = {
                            timestamp: n.timestamp,
                            focused: document.hasFocus()
                        };
                        e.directPostMessageToSW(ne.AreYouVisibleResponse, t)
                    } else {
                        const e = {
                                timestamp: n.timestamp
                            },
        ...
        installAlternatingWorker() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = yield this.getActiveState();
                e === ft.ThirdParty && E.a.info("[Service Worker Installation] 3rd party service worker detected.");
                const t = Pt.getAlternatingServiceWorkerHref(e, this.config, this.context.appConfig.appId),
                    i = `${x.b.getBaseUrl()}${this.config.registrationOptions.scope}`;
                ...
                try {
                    ...
                    if (E.a.error(`[Service Worker Installation] Installing service worker failed ${e}`), y.a.getWindowEnv() === H.a.OneSignalSubscriptionPopup) throw e;
                    const i = yield fetch(t);
                    if (403 === i.status || 404 === i.status) throw new Ke(i.status, i.statusText);
                    throw e
                }
                E.a.debug("[Service Worker Installation] Service worker installed.")
            })
        }
    }(Ot = vt || (vt = {}))[Ot.InvalidSafariSetup = 0] = "InvalidSafariSetup", Ot[Ot.Blocked = 1] = "Blocked", Ot[Ot.Dismissed = 2] = "Dismissed";
    class Tt extends p.a {
        constructor(e) {
            let t;
            switch (e) {
                case vt.InvalidSafariSetup:
    ...
    class At {
        ...
        subscribe(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                switch (t) {
                    case H.a.CustomIframe:
                    case H.a.Unknown:
                    case H.a.OneSignalProxyFrame:
                        throw new m(o.UnsupportedEnvironment)
                }
                let i;
                switch (t) {
                    case H.a.ServiceWorker:
                        i = yield this.subscribeFcmFromWorker(e);
                        break;
                    case H.a.Host:
                    case H.a.OneSignalSubscriptionModal:
                    case H.a.OneSignalSubscriptionPopup:
                        if ((yield OneSignal.privateGetNotificationPermission()) === k.Denied) throw new Q(q.Blocked);
                        if (At.isSafari()) {
        ...
        registerSubscription(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                e && (e = Z.deserialize(e));
                const i = K.createFromPushSubscription(this.config.appId, e, t);
                let n = void 0;
                ...
                const o = yield T.a.getSubscription();
                return o.deviceId = n, o.optedOut = !1, e ? At.isSafari() ? o.subscriptionToken = e.safariDeviceToken : o.subscriptionToken = e.w3cEndpoint ? e.w3cEndpoint.toString() : null : o.subscriptionToken = null, yield T.a.setSubscription(o), y.a.getWindowEnv() !== H.a.ServiceWorker && S.a.trigger(OneSignal.EVENTS.REGISTERED), "undefined" != typeof OneSignal && (OneSignal._sessionInitAlreadyRunning = !1), o
            })
        }
        ...
        unsubscribe(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (0 === e) throw new z;
                if (1 !== e) throw new z;
                if (y.a.getWindowEnv() !== H.a.ServiceWorker) throw new z; {
                    const {
                        deviceId: e
                    } = yield T.a.getSubscription();
                    yield C.updatePlayer(this.context.appConfig.appId, e, {
                        notification_types: L.MutedByApi
                    }), yield T.a.put("Options", {
                        key: "optedOut",
                        value: !0
                    })
        ...
        associateSubscriptionWithEmail(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = yield T.a.getEmailProfile();
        ...
        subscribeSafari() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (J.a.triggerNotificationPermissionChanged(), !i) throw new Tt(vt.InvalidSafariSetup);
                return e.setFromSafariSubscription(i), e
            })
        }
        subscribeFcmFromPage(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (y.a.getWindowEnv() !== H.a.ServiceWorker && Notification.permission === k.Default) {
                    yield S.a.trigger(OneSignal.EVENTS.PERMISSION_PROMPT_DISPLAYED);
                    const e = yield At.requestPresubscribeNotificationPermission();
                    switch (e === k.Default && (yield J.a.triggerNotificationPermissionChanged(!0)), e) {
                        case k.Default:
                            throw E.a.debug("Exiting subscription and not registering worker because the permission was dismissed."), OneSignal._sessionInitAlreadyRunning = !1, OneSignal._isRegisteringForPush = !1, new Q(q.Dismissed);
                        case k.Denied:
                            throw E.a.debug("Exiting subscription and not registering worker because the permission was blocked."), OneSignal._sessionInitAlreadyRunning = !1, OneSignal._isRegisteringForPush = !1, new Q(q.Blocked)
                    }
                }
                try {
                    yield this.context.serviceWorkerManager.installWorker()
                } catch (e) {
                    throw e instanceof Ke && (403 === e.status ? yield this.context.subscriptionManager.registerFailedSubscription(L.ServiceWorkerStatus403, this.context): 404 === e.status && (yield this.context.subscriptionManager.registerFailedSubscription(L.ServiceWorkerStatus404, this.context))), e
                }
        ...
        subscribeFcmFromWorker(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if ("denied" === i) throw new Q(q.Blocked);
                if ("prompt" === i) throw new Q(q.Default);
        ...
        subscribeWithVapidKey(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                switch (t) {
                    case 0:
                        if (!i) break;
                        i.options ? E.a.debug("[Subscription Manager] An existing push subscription exists and it's options is not null.") : (E.a.debug("[Subscription Manager] An existing push subscription exists and options is null. Unsubscribing from push first now."), yield At.doPushUnsubscribe(i));
                        break;
                    case 1:
                        i && (yield At.doPushUnsubscribe(i))
                }
                const [n, o] = yield At.doPushSubscribe(e, this.getVapidKeyForBrowser());
                yield At.updateSubscriptionTime(o, n.expirationTime);
                const s = Z.setFromW3cSubscription(n);
                return i && (s.existingW3cPushSubscription = Z.setFromW3cSubscription(i)), s
            })
        }
        static updateSubscriptionTime(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const i = yield T.a.getSubscription();
                e && (i.createdAt = (new Date).getTime()), i.expirationTime = t, yield T.a.setSubscription(i)
            })
        }
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                try {
                    ...
                    if ("InvalidStateError" == t.name) {
                        ...
                        return n && (yield At.doPushUnsubscribe(n)), [yield e.subscribe(i), !0]
                    }
                    throw t
                }
            })
        ...
        isSubscriptionExpiringForSecureIntegration() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (e !== ft.WorkerA && e !== ft.WorkerB) return !1;
                const t = yield this.context.serviceWorkerManager.getRegistration();
                if (!t) return !1;
        ...
        getSubscriptionState() {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (At.isSafari()) return this.getSubscriptionStateForSecure();
        ...
        getSubscriptionStateForSecure() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const i = yield this.context.serviceWorkerManager.getActiveState(), n = yield this.context.serviceWorkerManager.getRegistration(), o = yield this.context.permissionManager.getNotificationPermission(this.context.appConfig.safariWebId), s = i === ft.WorkerA || i === ft.WorkerB;
                return n ? {
                    subscribed: !(!e || o !== k.Granted || !s),
                    optedOut: !!t
                } : {
                    subscribed: !1,
                    optedOut: !!t
        ...
        getSubscriptionStateForInsecure() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const {
                    ...
                    subscriptionToken: t,
                    optedOut: i
                } = yield T.a.getSubscription(), n = yield this.context.permissionManager.getNotificationPermission(this.context.appConfig.safariWebId);
                return {
                    subscribed: !(!e || !t || n !== k.Granted),
                    optedOut: !!i
                }
            })
        }
        registerFailedSubscription(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                t.pageViewManager.isFirstPageView() && (t.subscriptionManager.registerSubscription(new Z, e), t.pageViewManager.incrementPageViewCount())
            })
        }
    }
    var Mt = class {
        static getServiceWorkerManager(e) {
            const t = e.appConfig,
                ...
                n = {
                    workerAPath: new $e(`/${i}OneSignalSDKWorker.js`),
                    workerBPath: new $e(`/${i}OneSignalSDKUpdaterWorker.js`),
                    registrationOptions: {
                        scope: "/"
                    }
                };
            return t.userConfig && (t.userConfig.path && (n.workerAPath = new $e(`${t.userConfig.path}${t.userConfig.serviceWorkerPath}`), n.workerBPath = new $e(`${t.userConfig.path}${t.userConfig.serviceWorkerUpdaterPath}`)), t.userConfig.serviceWorkerParam && (n.registrationOptions = t.userConfig.serviceWorkerParam)), new Ct(e, n)
        }
    ...
    class Nt {
        ...
        isDeviceIdAvailable() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return null != (yield T.a.getSubscription()).deviceId
            })
        }
        getDeviceId() {
            return Object(d.a)(this, void 0, void 0, function*() {
        ...
        sendPushDeviceRecordUpdate(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                e || (e = yield this.createDeviceRecord()), this.onSessionSent ? yield C.updatePlayer(this.context.appConfig.appId, t, Object.assign({
                    notification_types: L.Subscribed
        ...
        sendOnSessionUpdate(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const t = yield this.getDeviceId();
                if (e || (e = yield this.createDeviceRecord()), e.subscriptionState === L.Subscribed || !0 === OneSignal.config.enableOnSession) try {
                    this.context.sessionManager.upsertSession(t, e, ee.b.PlayerOnSession), this.onSessionSent = !0
                } catch (e) {
        ...
        sendPlayerCreate(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield ct.addExternalUserIdToDeviceRecord(e);
                try {
                    const t = yield C.createUser(e);
                    return t ? (E.a.info("Subscribed to web push and registered with OneSignal", e, t), this.onSessionSent = !0, this.context.sessionManager.upsertSession(t, e, ee.b.PlayerCreate), t) : void E.a.error("Failed to create user.")
                } catch (e) {
        ...
        sendExternalUserIdUpdate(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                t || (t = yield T.a.getExternalUserIdAuthHash());
                const i = {
        ...
        sendTagsUpdate(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const t = {
                    ...
                    i = yield T.a.getExternalUserIdAuthHash();
        ...
        sendPushPlayerUpdate(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (t || (yield Object(A.d)(OneSignal.EVENTS.REGISTERED), ({
                        deviceId: t
                    } = yield T.a.getSubscription())), t) return yield C.updatePlayer(this.context.appConfig.appId, t, e)
            })
        }
        sendOutcomeDirect(e, t, i, n) {
            return Object(d.a)(this, void 0, void 0, function*() {
                Object(A.s)("sendOutcomeDirect");
        ...
        sendOutcomeInfluenced(e, t, i, n) {
            return Object(d.a)(this, void 0, void 0, function*() {
                Object(A.s)("sendOutcomeInfluenced");
                const o = yield this.createDeviceRecord(), s = {
                    app_id: e,
                    id: i,
                    device_type: o.deliveryPlatform,
        ...
        sendOutcomeUnattributed(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
                Object(A.s)("sendOutcomeUnattributed");
    ...
    const kt = {
        ...
        jt = {
            type: N.Push,
            text: {
                actionMessage: _t.actionMessage,
                acceptButton: _t.acceptButton,
                cancelButton: _t.cancelButton
            },
            autoPrompt: !1,
            delay: xt
        };
    ...
    var Yt, Jt, Qt, Zt, Xt, ei, ti, ii, ni;
    ! function(e) {
    ...
    class oi {
        ...
        generateHtml() {
            ...
            let t, i, n;
            switch (Object(A.a)(e, Kt.channelCaptureContainer), e.id = Kt.channelCaptureContainer, this.promptOptions.type) {
                case N.Sms:
                    t = this.promptOptions.text.smsLabel || "Phone Number", i = this.getInputWithValidationElement(N.Sms, t), e.appendChild(i);
                    break;
                case N.Email:
                    t = this.promptOptions.text.emailLabel || "Email", n = this.getInputWithValidationElement(N.Email, t), e.appendChild(n);
                    break;
                case N.SmsAndEmail:
                    t = this.promptOptions.text.emailLabel || "Email", n = this.getInputWithValidationElement(N.Email, t), e.appendChild(n), t = this.promptOptions.text.smsLabel || "Phone Number", i = this.getInputWithValidationElement(N.Sms, t), e.appendChild(i)
            }
            return e
        }
        getValidationElementWithMessage(e) {
            ...
            return n.innerText = e, i.setAttribute("src", $t), t.appendChild(i), t.appendChild(n), t
        }
        getInputWithValidationElement(e, t) {
            ...
            return s.setAttribute("style", "clear:both"), r.setAttribute("style", "clear:both"), Object(A.a)(a, Kt.onesignalValidationElementHidden), Object(A.a)(a, Kt.onesignalValidationElement), a.id = i.validationElementId, n.title = t, n.innerText = t, n.htmlFor = i.inputElementId, o.type = i.domElementType, o.id = i.inputElementId, Object(A.a)(o, i.inputClass), Object(A.a)(c, Kt.inputWithValidationElement), c.id = i.wrappingDivId, c.appendChild(n), c.appendChild(s), c.appendChild(o), c.appendChild(r), c.appendChild(a), c
        }
        getTypeSpecificVariablesForValidationElemGeneration(e) {
            if (e === N.Email) return {
                message: "Please enter a valid email",
                domElementType: "email",
                validationElementId: qt.onesignalEmailValidationElement,
                inputElementId: qt.onesignalEmailInput,
                inputClass: Kt.onesignalEmailInput,
                wrappingDivId: qt.emailInputWithValidationElement
            };
            if (e === N.Sms) return {
                message: "Please enter a valid phone number",
                domElementType: "tel",
                validationElementId: qt.onesignalSmsValidationElement,
                inputElementId: qt.onesignalSmsInput,
                inputClass: Kt.onesignalSmsInput,
                wrappingDivId: qt.smsInputWithValidationElement
            };
            throw new Error("invalid channel type for input validation")
        }
        initializePhoneInputLibrary() {
            const e = Object(A.l)(`#${qt.onesignalSmsInput}`);
        ...
        addEmailInputEventListeners() {
            const e = Object(A.l)(`#${qt.onesignalEmailInput}`);
            e.addEventListener("keyup", () => {
                var t;
                const i = null === (t = e) || void 0 === t ? void 0 : t.value;
                this.emailInputFieldIsValid = oi.validateEmailInputWithReturnVal(i), this.updateValidationOnEmailInputChange()
            })
        }
        updateValidationOnSmsInputChange() {
            const e = Object(A.l)(`#${qt.smsInputWithValidationElement}`),
                t = Object(A.l)(`#${qt.onesignalSmsValidationElement}`);
            Object(A.v)(e, Kt.onesignalErrorInput), Object(A.a)(t, Kt.onesignalValidationElementHidden)
        }
        updateValidationOnEmailInputChange() {
            const e = Object(A.l)(`#${qt.emailInputWithValidationElement}`),
                t = Object(A.l)(`#${qt.onesignalEmailValidationElement}`);
            Object(A.v)(e, Kt.onesignalErrorInput), Object(A.a)(t, Kt.onesignalValidationElementHidden)
        }
        loadPhoneLibraryScripts() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                e.src = Yt.Main, t.src = Yt.Utils, i.href = Yt.Stylesheet, i.rel = "stylesheet", e.integrity = Jt.Main, t.integrity = Jt.Utils, i.integrity = Jt.Stylesheet, e.crossOrigin = "anonymous", t.crossOrigin = "anonymous", i.crossOrigin = "anonymous", document.head.appendChild(e), document.head.appendChild(t), document.head.appendChild(i);
        ...
        mount() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = oi.isUsingSmsInputField(this.promptOptions.type),
                    t = oi.isUsingEmailInputField(this.promptOptions.type);
                e && (yield this.loadPhoneLibraryScripts());
                const i = this.generateHtml();
                Object(A.l)(`#${Bt.body}`).appendChild(i), e && (this.initializePhoneInputLibrary(), this.addSmsInputEventListeners()), t && this.addEmailInputEventListeners()
            })
        }
        ...
        getValueFromEmailInput() {
            var e;
            return (null === (e = Object(A.l)(`#${qt.onesignalEmailInput}`)) || void 0 === e ? void 0 : e.value) || ""
        }
        getValueFromSmsInput() {
            return this.itiOneSignal.getNumber(intlTelInputUtils.numberFormat.E164) || ""
        }
        static showSmsInputError(e) {
            const t = document.querySelector(`#${qt.onesignalSmsValidationElement}`),
                i = document.querySelector(`#${qt.smsInputWithValidationElement}`);
            t && i ? e ? (t.classList.remove(Kt.onesignalValidationElementHidden), i.classList.add(Kt.onesignalErrorInput)) : (t.classList.add(Kt.onesignalValidationElementHidden), i.classList.remove(Kt.onesignalErrorInput)) : E.a.error("OneSignal: couldn't find slidedown validation element")
        }
        static showEmailInputError(e) {
            const t = document.querySelector(`#${qt.onesignalEmailValidationElement}`),
                i = document.querySelector(`#${qt.emailInputWithValidationElement}`);
            t && i ? e ? (t.classList.remove(Kt.onesignalValidationElementHidden), i.classList.add(Kt.onesignalErrorInput)) : (t.classList.add(Kt.onesignalValidationElementHidden), i.classList.remove(Kt.onesignalErrorInput)) : E.a.error("OneSignal: couldn't find slidedown validation element")
        }
        static resetInputErrorStates(e) {
            switch (e) {
                case N.Sms:
                    oi.showSmsInputError(!1);
                    break;
                case N.Email:
                    oi.showEmailInputError(!1);
                    break;
                case N.SmsAndEmail:
                    oi.showSmsInputError(!1), oi.showEmailInputError(!1)
            }
        }
    ...
    class ri {
        ...
        create(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (null === this.notificationIcons) {
                    ...
                    this.notificationIcons = t, this.container.className.includes(Rt.container) && Object(A.w)(`#${Bt.container}`);
                    const i = e && this.tagCategories ? this.positiveUpdateButton : this.options.text.acceptButton,
                        ...
                        o = function(e) {
                            ...
                            } = e, s = t === Rt.defaultIcon ? Ht : t, r = t === Rt.defaultIcon ? Rt.defaultIcon : "", a = document.createElement("div"), c = document.createElement("div"), l = document.createElement("div"), d = document.createElement("div"), u = document.createElement("div"), g = document.createElement("div"), h = document.createElement("button"), p = document.createElement("button"), m = document.createElement("div"), b = document.createElement("div"), f = document.createElement("img");
                            return Object(A.a)(c, Rt.body), Object(A.a)(d, Rt.icon), Object(A.a)(l, Rt.message), Object(A.a)(g, Rt.footer), Object(A.a)(m, Rt.clearfix), Object(A.a)(b, Rt.clearfix), Object(A.a)(h, Vt.alignRight), Object(A.a)(h, Vt.primary), Object(A.a)(h, Vt.slidedownButton), Object(A.a)(p, Vt.alignRight), Object(A.a)(p, Vt.secondary), Object(A.a)(p, Vt.slidedownButton), a.id = Bt.normalSlidedown, c.id = Bt.body, u.id = Bt.loadingContainer, h.id = Bt.allowButton, p.id = Bt.cancelButton, g.id = Bt.footer, r && Object(A.a)(f, r), f.setAttribute("alt", "notification icon"), f.setAttribute("src", s || ""), l.innerText = i || "", h.innerText = n || "", p.innerText = o || "", d.appendChild(f), c.appendChild(d), c.appendChild(l), c.appendChild(m), c.appendChild(u), g.appendChild(h), g.appendChild(p), g.appendChild(b), a.appendChild(c), a.appendChild(g), a
                        }({
                        ...
                        s = document.createElement("div"),
                        r = document.createElement("div");
                    s.id = Bt.container, Object(A.a)(s, Rt.container), Object(A.a)(s, Rt.reset), Object(A.l)("body").appendChild(s), r.id = Bt.dialog, Object(A.a)(r, Rt.dialog), r.appendChild(o), this.container.appendChild(r), Object(A.a)(this.container, g.a.mobile ? Rt.slideUp : Rt.slideDown), this.allowButton.addEventListener("click", this.onSlidedownAllowed.bind(this)), this.cancelButton.addEventListener("click", this.onSlidedownCanceled.bind(this))
                }
            })
        }
        ...
        onSlidedownAllowed(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield ri.triggerSlidedownEvent(ri.EVENTS.ALLOW_CLICK)
            })
        }
        onSlidedownCanceled(e) {
            ri.triggerSlidedownEvent(ri.EVENTS.CANCEL_CLICK), this.close(), ri.triggerSlidedownEvent(ri.EVENTS.CLOSED)
        }
        close() {
            Object(A.a)(this.container, Rt.closeSlidedown), Object(A.u)(this.dialog, "animationend", (e, t) => {
                e.target !== this.dialog || "slideDownExit" !== e.animationName && "slideUpExit" !== e.animationName || (Object(A.w)(`#${Bt.container}`), t())
            }, !0)
        }
        setSaveState() {
            this.allowButton.disabled = !0, this.allowButton.textContent = null, this.allowButton.insertAdjacentElement("beforeend", this.getTextSpan(this.savingButton)), this.allowButton.insertAdjacentElement("beforeend", this.getIndicatorHolder()), Object(A.b)(this.buttonIndicatorHolder, "beforeend", Dt(zt.whiteLoadingIndicator)), Object(A.a)(this.allowButton, "disabled"), Object(A.a)(this.allowButton, Rt.savingStateButton)
        }
        removeSaveState() {
            this.allowButton.textContent = this.positiveUpdateButton, Object(A.w)(`#${Rt.buttonIndicatorHolder}`), this.allowButton.disabled = !1, Object(A.v)(this.allowButton, "disabled"), Object(A.v)(this.allowButton, Rt.savingStateButton)
        }
        setFailureState() {
            this.allowButton.textContent = null, this.allowButton.insertAdjacentElement("beforeend", this.getTextSpan(this.errorButton)), this.options.type === N.Category && (this.allowButton.insertAdjacentElement("beforeend", this.getIndicatorHolder()), Object(A.b)(this.buttonIndicatorHolder, "beforeend", function(e = "#FFFFFF") {
            ...
            }()), Object(A.a)(this.allowButton, "onesignal-error-state-button")), this.isShowingFailureState = !0
        }
        setFailureStateForInvalidChannelInput(e) {
            switch (e) {
                case Qt.InvalidSms:
                    oi.showSmsInputError(!0);
                    break;
                case Qt.InvalidEmail:
                    oi.showEmailInputError(!0);
                    break;
                case Qt.InvalidEmailAndSms:
                    oi.showSmsInputError(!0), oi.showEmailInputError(!0)
            }
        }
        removeFailureState() {
            Object(A.w)("#onesignal-button-indicator-holder"), Object(A.v)(this.allowButton, "onesignal-error-state-button"), j.isSlidedownPushDependent(this.options.type) || oi.resetInputErrorStates(this.options.type), this.isShowingFailureState = !1
        }
        getPlatformNotificationIcon() {
            return Object(A.m)(this.notificationIcons)
        }
        getIndicatorHolder() {
            const e = document.createElement("div");
            return e.id = Bt.buttonIndicatorHolder, Object(A.a)(e, Rt.buttonIndicatorHolder), e
        }
        getTextSpan(e) {
        ...
        get container() {
            return Object(A.l)(`#${Bt.container}`)
        }
        get dialog() {
            return Object(A.l)(`#${Bt.dialog}`)
        }
        get allowButton() {
            return Object(A.l)(`#${Bt.allowButton}`)
        }
        get cancelButton() {
            return Object(A.l)(`#${Bt.cancelButton}`)
        }
        get buttonIndicatorHolder() {
            return Object(A.l)(`#${Bt.buttonIndicatorHolder}`)
        }
        get slidedownFooter() {
            return Object(A.l)(`#${Bt.footer}`)
        }
        static get EVENTS() {
            return {
    ...
    class ci {
        ...
        static getBrowser() {
            return g.a.chrome ? X.Chrome : g.a.msedge ? X.Edge : g.a.opera ? X.Opera : g.a.firefox ? X.Firefox : this.isMacOSSafari() ? X.Safari : X.Other
        }
        static isMacOSSafari() {
            return void 0 !== window.safari || ai()
        }
        ...
        static isUsingSubscriptionWorkaround() {
            return x.a.isUsingSubscriptionWorkaround()
        }
        static supportsServiceWorkers() {
    ...
    class di {
        ...
        spawnAutoPrompts() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const i = OneSignal.config.userConfig.promptOptions,
                    ...
                    o = this.getDelayedPromptOptions(i, N.Native),
                    s = this.isPageViewConditionMet(o),
                    r = o.enabled && s,
                    a = n && r;
                if (r && !a) return void this.internalShowDelayedPrompt(N.Native, o.timeDelay || 0);
                const c = !!j.getFirstSlidedownPromptOptionsWithType(null === (e = i.slidedown) || void 0 === e ? void 0 : e.prompts, N.Push);
                a && !c && this.internalShowDelayedPrompt(N.Push, o.timeDelay || 0);
        ...
        internalShowDelayedPrompt(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (x.b.logMethodCall("internalShowDelayedPrompt"), "number" != typeof t) return void E.a.error("internalShowDelayedPrompt: timeDelay not a number");
                const {
                    requiresUserInteraction: n
                } = ci.getEnvironmentInfo();
                switch (n && e === N.Native && (e = N.Push), t > 0 && (yield li(1e3 * t)), e) {
                    case N.Native:
        ...
        internalShowNativePrompt() {
            return Object(d.a)(this, void 0, void 0, function*() {
                x.b.logMethodCall("internalShowNativePrompt"), this.isNativePromptShowing ? E.a.debug("Already showing autoprompt. Abort showing a native prompt.") : (this.isNativePromptShowing = !0, ie.markHttpSlidedownShown(), yield Fe.registerForPushNotifications(), this.isNativePromptShowing = !1, Te.markPromptDismissedWithType(ge.Push))
            })
        }
        internalShowSlidedownPrompt(e = {
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                x.b.logMethodCall("internalShowSlidedownPrompt"), e.slidedownPromptOptions || (e.slidedownPromptOptions = jt), ie.markHttpSlidedownShown(), 0 === (yield this.context.dynamicResourceLoader.loadSdkStylesheet()) ? (this.eventHooksInstalled || this.installEventHooksForSlidedown(), yield this.context.slidedownManager.createSlidedown(e)) : E.a.debug("Not showing slidedown permission message because styles failed to load.")
            })
        }
        internalShowCategorySlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                x.b.logMethodCall("internalShowCategorySlidedown"), yield this.internalShowParticularSlidedown(N.Category, e)
            })
        }
        internalShowSmsSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                x.b.logMethodCall("internalShowSmsSlidedown"), yield this.internalShowParticularSlidedown(N.Sms, e)
            })
        }
        internalShowEmailSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                x.b.logMethodCall("internalShowEmailSlidedown"), yield this.internalShowParticularSlidedown(N.Email, e)
            })
        }
        internalShowSmsAndEmailSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                x.b.logMethodCall("internalShowSmsAndEmailSlidedown"), yield this.internalShowParticularSlidedown(N.SmsAndEmail, e)
            })
        }
        internalShowParticularSlidedown(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const o = null === (n = null === (i = this.context.appConfig.userConfig.promptOptions) || void 0 === i ? void 0 : i.slidedown) || void 0 === n ? void 0 : n.prompts,
                    s = (null === t || void 0 === t ? void 0 : t.slidedownPromptOptions) || j.getFirstSlidedownPromptOptionsWithType(o, e);
                if (!s) {
                    if (e !== N.Push) return void E.a.error(`OneSignal: slidedown of type '${e}' couldn't be shown. Check your configuration` + " on the OneSignal dashboard or your custom code initialization.");
            ...
            this.eventHooksInstalled = !0,
                function() {
                    ...
                    switch (e) {
                        case N.Push:
                        case N.Category:
                            E.a.debug("Setting flag to not show the slidedown to the user again."), Te.markPromptDismissedWithType(ge.Push);
                            break;
                        default:
                            E.a.debug("Setting flag to not show the slidedown to the user again."), Te.markPromptDismissedWithType(ge.NonPush)
                    }
                })
        }
        ...
        getDelayedPromptOptions(e, t) {
            ...
            const r = {
                enabled: !1,
                autoPrompt: !1,
                timeDelay: xt.timeDelay,
                pageViews: xt.pageViews
            };
            ...
            switch (t) {
                ...
                case N.SmsAndEmail:
                    const {
                        userConfig: c
                    } = this.context.appConfig, l = j.getFirstSlidedownPromptOptionsWithType((null === (n = null === (i = c.promptOptions) || void 0 === i ? void 0 : i.slidedown) || void 0 === n ? void 0 : n.prompts) || [], t);
                    return {
                        enabled: !!l,
    ...
    class ui {
        ...
        notifySWToDeactivateSession(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                this.context.environmentInfo.isBrowserAndSupportsServiceWorkers && !this.context.environmentInfo.isUsingSubscriptionWorkaround ? (E.a.debug("Notify SW to deactivate session"), yield this.context.workerMessenger.unicast(ne.SessionDeactivate, o)) : this.context.environmentInfo.canTalkToServiceWorker && this.context.environmentInfo.isUsingSubscriptionWorkaround ? (E.a.debug("Notify SW to deactivate session"), yield OneSignal.proxyFrameHost.runCommand(OneSignal.POSTMAM_COMMANDS.SESSION_DEACTIVATE, o)) : E.a.debug("Notify deactivate: do nothing")
            })
        }
        handleVisibilityChange() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = document.visibilityState,
                    [t, i] = yield Promise.all([ie.getDeviceId(), ie.createDeviceRecord(this.context.appConfig.appId, !0)]);
                if ("visible" === e) return this.setupOnFocusAndOnBlurForSession(), E.a.debug("handleVisibilityChange", "visible", `hasFocus: ${document.hasFocus()}`), void(document.hasFocus() && (yield this.notifySWToUpsertSession(t, i, ee.b.VisibilityVisible)));
                if ("hidden" !== e) E.a.warn("Unhandled visibility state happened", e);
                    ...
                    const [e, t] = yield Promise.all([ie.getDeviceId(), ie.createDeviceRecord(this.context.appConfig.appId)]);
                    yield this.notifySWToDeactivateSession(e, t, ee.b.VisibilityHidden)
                }
            })
        }
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = x.a.isHttps(),
                    t = {
                        sessionThreshold: this.context.appConfig.sessionThreshold,
                        enableSessionDuration: this.context.appConfig.enableSessionDuration,
                        sessionOrigin: ee.b.BeforeUnload,
                        isHttps: e,
                        isSafari: x.a.isSafari(),
                        outcomesConfig: this.context.appConfig.userConfig.outcomes
                    };
                e ? (E.a.debug("Notify SW to deactivate session (beforeunload)"), this.context.workerMessenger.directPostMessageToSW(ne.SessionDeactivate, t)) : (E.a.debug("Notify iframe to notify SW to deactivate session (beforeunload)"), yield OneSignal.proxyFrameHost.runCommand(OneSignal.POSTMAM_COMMANDS.SESSION_DEACTIVATE, t))
            })
        }
        handleOnFocus(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (E.a.debug("handleOnFocus", e), e.target !== window) return;
                const [t, i] = yield Promise.all([ie.getDeviceId(), ie.createDeviceRecord(this.context.appConfig.appId, !0)]);
                yield this.notifySWToUpsertSession(t, i, ee.b.Focus)
            })
        }
        handleOnBlur(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (E.a.debug("handleOnBlur", e), e.target !== window) return;
                const [t, i] = yield Promise.all([ie.getDeviceId(), ie.createDeviceRecord(this.context.appConfig.appId)]);
                yield this.notifySWToDeactivateSession(t, i, ee.b.Blur)
            })
        }
        upsertSession(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const n = this.notifySWToUpsertSession(e, t, i);
                this.context.environmentInfo.isBrowserAndSupportsServiceWorkers || this.context.environmentInfo.isUsingSubscriptionWorkaround ? this.context.environmentInfo.canTalkToServiceWorker ? this.setupSessionEventListeners() : (this.onSessionSent = i === ee.b.PlayerCreate, OneSignal.emitter.emit(OneSignal.EVENTS.SESSION_STARTED)) : this.context.environmentInfo.isBrowserAndSupportsServiceWorkers || this.context.environmentInfo.isUsingSubscriptionWorkaround || (this.onSessionSent = i === ee.b.PlayerCreate, OneSignal.emitter.emit(OneSignal.EVENTS.SESSION_STARTED)), yield n
            })
        }
        ...
        sendOnSessionUpdateFromPage(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (e || (e = yield ie.createDeviceRecord(this.context.appConfig.appId)), e.subscriptionState === L.Subscribed || !0 === OneSignal.config.enableOnSession) {
                    try {
                        const i = yield C.updateUserSession(t, e);
                        if (this.onSessionSent = !0, i !== t) {
                            const e = yield T.a.getSubscription();
                            e.deviceId = i, yield T.a.setSubscription(e)
                        }
                    } catch (e) {
                        E.a.error(`Failed to update user session. Error "${e.message}" ${e.stack}`)
                    }
    ...
    class gi {
        ...
        static getCheckedTagCategories(e, t) {
            if (!t) return e;
            if (gi.isTagObjectEmpty(t)) {
                const t = Object(A.h)(e);
                return gi.markAllTagsAsSpecified(t, !0), t
            }
            return Object(A.h)(e).map(e => {
                const i = t[e.tag];
                return e.checked = gi.getCheckedStatusForTagValue(i), e
            })
        }
    ...
    class hi {
        ...
        sendTags() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const e = gi.convertTagsBooleansToApi(this.tagsFromTaggingContainer),
                    t = gi.getObjectDifference(e, this.remoteTags);
                return gi.isTagObjectEmpty(t) ? (E.a.warn("OneSignal: no change detected in Category preferences. Skipping tag update."), t) : yield OneSignal.sendTags(t)
            })
        }
    ...
    class pi {
        mount(e, t) {
            ...
            Object(A.l)(`#${Bt.body}`).appendChild(i), this.taggingContainer && this.taggingContainer.addEventListener("change", this.toggleCheckedTag);
            const n = Object(A.l)(`#${Bt.allowButton}`);
            n.disabled = !1, Object(A.v)(n, "disabled"), Object(A.w)(`#${Bt.loadingContainer}`)
        }
        load() {
            const e = Object(A.l)(`#${Bt.loadingContainer}`),
                t = Object(A.l)(`#${Bt.allowButton}`),
                i = document.createElement("div");
            Object(A.a)(e, `${Rt.loadingContainer}`), Object(A.a)(i, Lt.loadingMessage), Object(A.a)(t, "disabled"), Object(A.b)(e, "beforeend", Dt(zt.greyLoadingIndicator)), i.innerText = Gt.fetchingPreferences, e.appendChild(i), t.disabled = !0
        }
        generateHtml(e, t) {
            const i = gi.getCheckedTagCategories(e, t),
                n = i.filter(e => i.indexOf(e) % 2 == 0),
                o = i.filter(e => i.indexOf(e) % 2),
                s = document.createElement("div"),
                r = document.createElement("div"),
                a = document.createElement("div");
            return Object(A.a)(s, Lt.taggingContainerCol), Object(A.a)(r, Lt.taggingContainerCol), Object(A.a)(a, Lt.taggingContainer), a.id = Ft.taggingContainer, n.forEach(e => {
        ...
        getCategoryLabelElement(e) {
            ...
            return Object(A.a)(i, Lt.categoryLabel), Object(A.a)(n, Lt.categoryLabelText), Object(A.a)(o, Lt.categoryLabelInput), Object(A.a)(s, Lt.checkmark), i.title = t, n.innerText = t, o.type = "checkbox", o.value = e.tag, o.checked = !!e.checked, i.appendChild(n), i.appendChild(o), i.appendChild(s), r.setAttribute("style", "clear:both"), a.appendChild(i), a.appendChild(r), a
        }
        get taggingContainer() {
            const e = `#${Bt.body} > div.${Lt.taggingContainer}`;
            return Object(A.l)(e)
        }
        toggleCheckedTag(e) {
            const t = e.target;
        ...
        static getValuesFromTaggingContainer() {
            const e = `#${Bt.body} > div.${Lt.taggingContainer}` + "> div > div > label > input[type=checkbox]",
                t = {};
    ...
    class mi extends p.a {
        constructor(e) {
            super(`The permission message of type ${e||"unknown"} was previously dismissed.`), Object.setPrototypeOf(this, mi.prototype)
        }
    }
    class bi {
        constructor(e) {
        ...
        show() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                i.id = Bt.container, e.id = Wt.toastText, Object(A.a)(e, Ut.toastText), Object(A.a)(i, Rt.container), Object(A.a)(i, Rt.reset), Object(A.l)("body").appendChild(i), n.id = Bt.dialog, Object(A.a)(n, Rt.dialog), n.appendChild(e), this.container.appendChild(n), Object(A.a)(this.container, g.a.mobile ? Rt.slideUp : Rt.slideDown), bi.triggerSlidedownEvent(bi.EVENTS.SHOWN)
            })
        }
        static triggerSlidedownEvent(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
    ...
    class fi extends p.a {
        constructor() {
            super("This operation can only be performed when the user is not subscribed."), Object.setPrototypeOf(this, fi.prototype)
        }
    }
    class Si extends p.a {
        constructor(e) {
            super(`This operation can only be performed when the channel '${e}' does not yet exist.`), Object.setPrototypeOf(this, Si.prototype)
        }
    }
    class vi {
        constructor(e, t) {
        ...
        checkIfSlidedownShouldBeShown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                var t;
                const i = (yield OneSignal.privateGetNotificationPermission()) === k.Denied,
                ...
                let c = !1;
                if (a && (c = j.isSlidedownPushDependent(a)), c) {
                    if (n) return !!e.isInUpdateMode || (E.a.info(new fi), !1);
                    if (s = Te.wasPromptOfTypeDismissed(ge.Push), !o) throw new b(r.OptedOut);
                    if (i) return E.a.info(new Q(q.Blocked)), !1
                } else {
                    if (!e.force) {
                        const e = !!(yield T.a.getSMSProfile()).subscriptionId,
                            t = !!(yield T.a.getEmailProfile()).subscriptionId,
                            i = e && t;
                        if (e && a === N.Sms) return E.a.info(new Si(N.Sms)), !1;
                        if (t && a === N.Email) return E.a.info(new Si(N.Email)), !1;
                        if (i && a === N.SmsAndEmail) return E.a.info(new Si(N.SmsAndEmail)), !1
                    }
                    s = Te.wasPromptOfTypeDismissed(ge.NonPush)
                }
                return !(s && !e.force && !e.isInUpdateMode) || (E.a.info(new mi(a)), !1)
            })
        }
        registerForPush() {
            const e = {
            ...
            Fe.registerForPushNotifications(e)
        }
        handleAllowForCategoryType() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = pi.getValuesFromTaggingContainer();
                this.context.tagManager.storeTagValuesToUpdate(e), B.getIsPushNotificationsEnabled() ? (OneSignal.slidedown.setSaveState(), yield this.context.tagManager.sendTags(!0)) : this.registerForPush()
            })
        }
        handleAllowForEmailType() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (!e || t) throw new si(Qt.InvalidEmail);
        ...
        handleAllowForSmsType() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (!e || t) throw new si(Qt.InvalidSms);
        ...
        handleAllowForSmsAndEmailType() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (!e && !t || i && n) throw new si(Qt.InvalidEmailAndSms);
                ...
                if (!t) throw new si(Qt.InvalidEmail);
                if (i || this.updateEmail(o), !e) throw new si(Qt.InvalidSms);
                n || this.updateSMS(s)
            })
        }
        updateEmail(e) {
        ...
        showConfirmationToast() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                yield li(1e3);
                const t = new bi(e);
                yield t.show(), yield li(5e3), t.close(), bi.triggerSlidedownEvent(bi.EVENTS.CLOSED)
            })
        }
        ...
        mountTaggingContainer(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                var t;
                x.a.logMethodCall("mountTaggingContainer");
                try {
                    let i = {};
                    const n = new pi,
                    ...
                    if (e.isInUpdateMode) {
                        ...
                        this.context.tagManager.storeRemotePlayerTags(e), i = gi.convertTagsApiToBooleans(e)
                    } else gi.markAllTagsAsSpecified(o, !0);
                    n.mount(o, i)
                } catch (e) {
        ...
        mountChannelCaptureContainer(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                x.a.logMethodCall("mountChannelCaptureContainer");
                try {
                    if (e.slidedownPromptOptions) {
                        const t = new oi(e.slidedownPromptOptions);
        ...
        handleAllowClick() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                switch (e && (e.close(), j.isSlidedownPushDependent(t) || (yield this.showConfirmationToast()), yield li(1e3), ri.triggerSlidedownEvent(ri.EVENTS.CLOSED)), t) {
                    case N.Push:
                    case N.Category:
                        E.a.debug("Setting flag to not show the slidedown to the user again."), Te.markPromptDismissedWithType(ge.Push);
                        break;
        ...
        enqueue(e) {
            this.slidedownQueue.push(e), ri.triggerSlidedownEvent(ri.EVENTS.QUEUED)
        }
        dequeue() {
        ...
        createSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                x.a.logMethodCall("createSlidedown");
                try {
                ...
                if (this.isSlidedownShowing) this.enqueue(e);
                else try {
                    this.setIsSlidedownShowing(!0);
                    const t = e.slidedownPromptOptions || jt;
                    OneSignal.slidedown = new ri(t), yield OneSignal.slidedown.create(e.isInUpdateMode), yield this.mountAuxiliaryContainers(e), E.a.debug("Showing OneSignal Slidedown"), ri.triggerSlidedownEvent(ri.EVENTS.SHOWN)
                } catch (e) {
    ...
    class Oi {
        constructor(e) {
            this.appConfig = e, "undefined" != typeof OneSignal && OneSignal.environmentInfo && (this.environmentInfo = OneSignal.environmentInfo), this.secondaryChannelManager = new It, this.subscriptionManager = Mt.getSubscriptionManager(this), this.serviceWorkerManager = Mt.getServiceWorkerManager(this), this.pageViewManager = new He, this.permissionManager = new D, this.workerMessenger = new de(this), this.updateManager = new Nt(this), this.sessionManager = new ui(this), this.tagManager = new hi(this), this.slidedownManager = new vi(this, this.secondaryChannelManager), this.promptsManager = new di(this), this.dynamicResourceLoader = new ue, this.metricsManager = new Ve(e.metrics.enable, e.metrics.mixpanelReportingToken)
        }
    }! function(e) {
    ...
    class yi {
        static upgradeConfigToVersionTwo(e) {
            var t, i, n;
            yi.isPromptOptionsVersion0(e.promptOptions) && (e.promptOptions = yi.convertConfigToVersionOne(e.promptOptions)), yi.isSlidedownConfigVersion1(null === (t = e.promptOptions) || void 0 === t ? void 0 : t.slidedown) && (null === (i = e.promptOptions) || void 0 === i ? void 0 : i.slidedown) && (e.promptOptions.slidedown = yi.convertConfigToVersionTwo(null === (n = e.promptOptions) || void 0 === n ? void 0 : n.slidedown))
        }
        ...
        static convertConfigToVersionTwo(e) {
            var t, i, n, o;
            const s = j.isCategorySlidedownConfiguredVersion1(e) ? N.Category : N.Push;
            let r, a;
            return s === N.Category && (r = null === (t = e.categories) || void 0 === t ? void 0 : t.positiveUpdateButton, a = null === (i = e.categories) || void 0 === i ? void 0 : i.negativeUpdateButton), {
                prompts: [...e.prompts || [], {
                    type: s,
    ...
    }(ni = ii || (ii = {}))[ni.Dashboard = 0] = "Dashboard", ni[ni.JavaScript = 1] = "JavaScript";
    const wi = 10;
    class Ei {
        static getAppConfig(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                try {
                    if (!e || !e.appId || !x.b.isValidUuid(e.appId)) throw new f(c.InvalidAppId);
                    const i = yield t(e.appId);
                    yi.upgradeConfigToVersionTwo(e);
        ...
        static checkRestrictedOrigin(e) {
            if (e.restrictedOriginEnabled && y.a.getWindowEnv() !== H.a.ServiceWorker && window.top === window && !w.b.contains(window.location.hostname, ".os.tc") && !w.b.contains(window.location.hostname, ".onesignal.com") && !this.doesCurrentOriginMatchConfigOrigin(e.origin)) throw new f(c.WrongSiteUrl, {
                siteUrl: e.origin
            })
        }
        ...
        static getIntegrationCapabilities(e) {
            switch (e) {
                ...
                case Xt.WordPress:
                    return {
                        configuration: ii.JavaScript
                    };
                default:
                    return {
                        configuration: ii.Dashboard
                    }
            }
        }
        static getMergedConfig(e, t) {
            const i = this.getConfigIntegrationKind(t),
                ...
                s = x.b.internalIsUsingSubscriptionWorkaround(n, o),
            ...
            return {
                ...
                enableOnSession: w.b.valueOrDefault(t.features.enable_on_session, kt.enableOnSessionForUnsubcribed),
                sessionThreshold: w.b.valueOrDefault(t.features.session_threshold, kt.reportingThreshold),
                enableSessionDuration: w.b.valueOrDefault(t.features.web_on_focus_enabled, kt.enableOnFocus)
            }
        }
        static getConfigIntegrationKind(e) {
            return e.config.integration ? e.config.integration.kind : Xt.Custom
        }
        ...
        static injectDefaultsIntoPromptOptions(e, t, i, n = !1) {
            ...
            if (c.slidedown ? c.slidedown.prompts = null === (s = null === (o = c.slidedown) || void 0 === o ? void 0 : o.prompts) || void 0 === s ? void 0 : s.map(e => {
                    ...
                    if (e.type = w.b.getValueOrDefault(e.type, N.Push), e.type === N.Category && (e.text = Object.assign(Object.assign({}, e.text), {
                            positiveUpdateButton: w.b.getValueOrDefault(null === (t = e.text) || void 0 === t ? void 0 : t.positiveUpdateButton, _t.categoryDefaults.positiveUpdateButton),
                            negativeUpdateButton: w.b.getValueOrDefault(null === (i = e.text) || void 0 === i ? void 0 : i.negativeUpdateButton, _t.categoryDefaults.negativeUpdateButton),
                            updateMessage: w.b.getValueOrDefault(null === (n = e.text) || void 0 === n ? void 0 : n.updateMessage, _t.categoryDefaults.updateMessage)
                        })), e.text = Object.assign(Object.assign({}, e.text), {
                            actionMessage: w.b.getValueOrDefault(null === (o = e.text) || void 0 === o ? void 0 : o.actionMessage, _t.actionMessage),
                            acceptButton: w.b.getValueOrDefault(null === (s = e.text) || void 0 === s ? void 0 : s.acceptButton, _t.acceptButton),
                            cancelButton: w.b.getValueOrDefault(null === (r = e.text) || void 0 === r ? void 0 : r.cancelButton, _t.cancelButton),
                            confirmMessage: w.b.getValueOrDefault(null === (a = e.text) || void 0 === a ? void 0 : a.confirmMessage, _t.confirmMessage)
                        }), e.autoPrompt = w.b.getValueOrDefault(e.autoPrompt, !0), e.delay = {
                            pageViews: w.b.getValueOrDefault(null === (c = e.delay) || void 0 === c ? void 0 : c.pageViews, xt.pageViews),
                            timeDelay: w.b.getValueOrDefault(null === (l = e.delay) || void 0 === l ? void 0 : l.timeDelay, xt.timeDelay)
                        }, e.categories) {
                        const {
                            categories: t
                        } = e;
                        e.categories = gi.limitCategoriesToMaxCount(t, wi)
                    }
                    return e
                }) : (c.slidedown = {
                    prompts: []
                }, c.slidedown.prompts = [jt]), c.native ? (c.native.enabled = !!c.native.enabled, c.native.autoPrompt = c.native.hasOwnProperty("autoPrompt") ? !!c.native.enabled && !!c.native.autoPrompt : !!c.native.enabled, c.native.pageViews = w.b.getValueOrDefault(c.native.pageViews, xt.pageViews), c.native.timeDelay = w.b.getValueOrDefault(c.native.timeDelay, xt.timeDelay)) : c.native = {
                    enabled: !1,
                    autoPrompt: !1,
                    pageViews: xt.pageViews,
                    timeDelay: xt.timeDelay
            ...
            return c.autoPrompt = c.native.autoPrompt || j.isSlidedownAutoPromptConfigured(c.slidedown.prompts), c
        }
        static getPromptOptionsForDashboardConfiguration(e) {
            const t = e.config.staticPrompts,
                i = t.native ? {
                    ...
                    pageViews: w.b.getValueOrDefault(t.native.pageViews, xt.pageViews),
                    timeDelay: w.b.getValueOrDefault(t.native.timeDelay, xt.timeDelay)
                } : {
                    enabled: !1,
                    autoPrompt: !1,
                    pageViews: xt.pageViews,
        ...
        static getUserConfigForConfigIntegrationKind(e, t, i, n = !1) {
            switch (this.getIntegrationCapabilities(e).configuration) {
                ...
                case ii.JavaScript:
                    const o = Object.assign(Object.assign(Object.assign(Object.assign({}, t), {
                        ...
                        serviceWorkerUpdaterPath: "undefined" != typeof OneSignal && OneSignal.SERVICE_WORKER_UPDATER_PATH ? OneSignal.SERVICE_WORKER_UPDATER_PATH : "OneSignalSDKUpdaterWorker.js",
                        path: t.path ? t.path : "/"
                    }), {
                        outcomes: {
                            direct: i.config.outcomes.direct,
    ...
    class Ii {
        getAppConfig(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Ei.getAppConfig(e, rt.downloadServerAppConfig)
            })
        }
        getMergedConfig(e, t) {
            return Ei.getMergedConfig(e, t)
        }
    }
    class Pi {
        constructor(e) {
        ...
        initialize() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const t = yield(new Ii).getAppConfig(e);
                return OneSignal.environmentInfo = ci.getEnvironmentInfo(), OneSignal.context = new Oi(t), OneSignal.context.workerMessenger.listen(!0), OneSignal.initialized = !0, this.loadPromise = {}, this.loadPromise.promise = new Promise((e, t) => {
                    this.loadPromise.resolver = e, this.loadPromise.rejector = t
        ...
        subscribe() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = B.getIsPushNotificationsEnabled(),
                    t = opener || parent;
                e ? t && window.close() : te.registerForPush()
            })
        }
    }
    class Ci extends Pi {
        ...
        onProxyFrameInitializing(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (OneSignal.config = t, Fe.installNativePromptPermissionChangedHook(), (yield T.a.get("Options", "defaultUrl")) || (yield T.a.put("Options", {
                        key: "defaultUrl",
                        value: new URL(OneSignal.config.pageUrl).origin
                    })), yield T.a.put("Options", {
                        key: "lastKnownHostUrl",
                        value: OneSignal.config.pageUrl
                    }), yield Fe.initSaveState(), yield Fe.storeInitialValues(), yield Fe.saveInitOptions(), navigator.serviceWorker && "https:" === window.location.protocol) try {
        ...
        onUnsubscribeFromPush(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                try {
                    yield Object(A.z)(), e.reply(OneSignal.POSTMAM_COMMANDS.REMOTE_OPERATION_COMPLETE)
                } catch (e) {
        ...
        onMarkPromptDismissed(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return E.a.debug("(Reposted from iFrame -> Host) Marking prompt as dismissed."), yield Te.markPromptDismissedWithType(ge.Push), e.reply(OneSignal.POSTMAM_COMMANDS.REMOTE_OPERATION_COMPLETE), !1
            })
        }
        onIsSubscribed(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
        ...
        onProcessExpiringSubscriptions(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                OneSignal.context, yield Fe.processExpiringSubscriptions();
        ...
        onSessionUpsert(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = OneSignal.context,
                    i = e.data;
                t.workerMessenger.directPostMessageToSW(ne.SessionUpsert, i), e.reply(!0)
            })
        }
        onSessionDeactivate(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = OneSignal.context,
                    i = e.data;
                t.workerMessenger.directPostMessageToSW(ne.SessionDeactivate, i), e.reply(!0)
            })
        }
        ...
        onAreYouVisibleResponse(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const t = OneSignal.context,
                    i = e.data;
                t.workerMessenger.directPostMessageToSW(ne.AreYouVisibleResponse, i), e.reply(!0)
            })
        }
    }
    class Ti extends Pi {
        ...
        establishCrossOriginMessaging() {
            this.messenger && this.messenger.destroy(), this.messenger = new re(window.parent, this.options.origin, this.options.origin)
        }
    }
    class Ai extends Pi {
        constructor(e) {
        ...
        establishCrossOriginMessaging() {
            this.messenger = new re(window.opener, this.options.origin, this.options.origin), this.messenger.once(OneSignal.POSTMAM_COMMANDS.CONNECTED, this.onMessengerConnected.bind(this)), this.messenger.postMessage(OneSignal.POSTMAM_COMMANDS.POPUP_BEGIN_MESSAGEPORT_COMMS, null), this.messenger.listen()
        }
    ...
    class Mi {
        static initHttp(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                switch (E.a.debug(`Called %cinitHttp(${JSON.stringify(e,null,4)})`, Object(A.k)("code")), y.a.getWindowEnv()) {
                    case H.a.OneSignalProxyFrame:
                        OneSignal.proxyFrame = new Ci(e), yield OneSignal.proxyFrame.initialize(), $.ensureBackwardsCompatibility(OneSignal);
                        break;
                    case H.a.OneSignalSubscriptionPopup:
                        OneSignal.subscriptionPopup = new Ai(e), yield OneSignal.subscriptionPopup.initialize(), $.ensureBackwardsCompatibility(OneSignal), S.a.trigger("httpInitialize");
                        break;
                    case H.a.OneSignalSubscriptionModal:
                        OneSignal.subscriptionModal = new Ti(e), OneSignal.subscriptionModal.establishCrossOriginMessaging(), OneSignal.subscriptionModal.initialize(), $.ensureBackwardsCompatibility(OneSignal), S.a.trigger("httpInitialize");
                        break;
                    default:
        ...
        load() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                return e.style.display = "none", e.src = this.url.toString(), e.sandbox = "allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation", this.loadPromise = {}, this.loadPromise.promise = new Promise((e, t) => {
                    this.loadPromise.resolver = e, this.loadPromise.rejector = t
                }), document.body.appendChild(e), e.onload = this.onFrameLoad.bind(this), this.element = e, Object(A.x)(this.loadPromise.promise, ki.LOAD_TIMEOUT_MS).catch(() => {
        ...
        onMessengerConnect(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                E.a.debug(`Successfully established cross-origin communication for iFrame at ${this.url.toString()}`), this.messenger.message(OneSignal.POSTMAM_COMMANDS.IFRAME_POPUP_INITIALIZE, {
                    hostInitOptions: Object(A.h)(OneSignal.config),
    ...
    class xi {
        ...
        static discoverAltOrigin(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = xi.getOneSignalProxyIframeUrls(e),
                    i = [];
                for (const e of t) {
                    const t = new ki(e);
                    yield t.load(), i.push(t)
                }
                const n = yield xi.subscribedProxyFrameHosts(i);
                let o;
                yield xi.removeDuplicatedAltOriginSubscription(n), o = 0 === n.length ? i[0] : n[0];
        ...
        static getCanonicalSubscriptionUrls(e, t = y.a.getApiEnv()) {
            const i = xi.getWildcardLegacySubscriptionDomain(t),
                n = new URL(`https://${e.subdomain}.${i}`);
            if (t !== Ni.a.Production) return [n];
        ...
        static getWildcardLegacySubscriptionDomain(e) {
            ...
            let i = 2;
            return e === Ni.a.Staging && (i = 3), w.a.lastParts(t.host, ".", i)
        }
        static getOneSignalProxyIframeUrls(e) {
            const t = xi.getCanonicalSubscriptionUrls(e);
    ...
    class Ri {
        static throwIfInvalidAuthHashOptions(e, t) {
            ...
            const n = i[0],
                o = e[n];
            return o ? (Ri.throwIfInvalidAuthHash(o, `options.${n}`), o) : void 0
        }
        static throwIfInvalidAuthHash(e, t) {
            if (e && e.length !== Ri.VALID_AUTH_HASH_LENGTH) throw new InvalidArgumentError.a(t, InvalidArgumentError.b.Malformed)
        }
    }
    Ri.VALID_AUTH_HASH_LENGTH = 64, i.d(t, "default", function() {
        return Ui
    });
    class Ui {
        static setDefaultNotificationUrl(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                yield Object(A.c)(), Object(A.s)("setDefaultNotificationUrl", e);
                const t = yield T.a.getAppState();
                t.defaultNotificationUrl = e, yield T.a.setAppState(t)
            })
        }
        static setDefaultTitle(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), Object(A.s)("setDefaultTitle", e);
                const t = yield T.a.getAppState();
                t.defaultNotificationTitle = e, yield T.a.setAppState(t)
            })
        }
        static setEmail(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (!e) throw new InvalidArgumentError.a("email", InvalidArgumentError.b.Empty);
                if (!Object(A.r)(e)) throw new InvalidArgumentError.a("email", InvalidArgumentError.b.Malformed);
                const i = Ri.throwIfInvalidAuthHashOptions(t, ["identifierAuthHash", "emailAuthHash"]);
                return Object(A.s)("setEmail", e, t), yield Object(A.c)(), yield this.context.secondaryChannelManager.email.setIdentifier(e, i)
            })
        }
        static setSMSNumber(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (!e) throw new InvalidArgumentError.a("smsNumber", InvalidArgumentError.b.Empty);
                const i = Ri.throwIfInvalidAuthHashOptions(t, ["identifierAuthHash"]);
                return Object(A.s)("setSMSNumber", e, t), yield Object(A.c)(), yield this.context.secondaryChannelManager.sms.setIdentifier(e, i)
            })
        }
        static logoutEmail() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Object(A.c)(), yield this.context.secondaryChannelManager.email.logout()
            })
        }
        static logoutSMS() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Object(A.c)(), yield this.context.secondaryChannelManager.sms.logout()
            })
        }
        static isPushNotificationsSupported() {
            return Object(A.s)("isPushNotificationsSupported"), !0
        }
        static initializeConfig(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = yield(new Ii).getAppConfig(e);
                E.a.debug(`OneSignal: Final web app config: %c${JSON.stringify(t,null,4)}`, Object(A.k)("code")), Ui.config = t, Ui.environmentInfo = ci.getEnvironmentInfo(), Ui.context = new Oi(t), Ui.config = Ui.context.appConfig
            })
        }
        static init(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (Object(A.s)("init"), yield Fe.polyfillSafariFetch(), Fe.errorIfInitAlreadyCalled(), yield Ui.initializeConfig(e), !Ui.config) throw new Error("OneSignal config not initialized!");
                if (!g.a.safari || Ui.config.safariWebId) {
                    if (Ui.config.userConfig.requiresUserPrivacyConsent) {
                        if (!(yield T.a.getProvideUserConsent())) return void(Ui.pendingInit = !0)
                    }
                    yield Ui.delayedInit()
        ...
        static delayedInit() {
            return Object(d.a)(this, void 0, void 0, function*() {
                function e() {
                    return Object(d.a)(this, void 0, void 0, function*() {
                        if (!Ui.__initAlreadyCalled) {
                            if (Ui.__initAlreadyCalled = !0, Ui.emitter.on(Ui.EVENTS.NATIVE_PROMPT_PERMISSIONCHANGED, V.onNotificationPermissionChange), Ui.emitter.on(Ui.EVENTS.SUBSCRIPTION_CHANGED, V._onSubscriptionChanged), Ui.emitter.on(Ui.EVENTS.SDK_INITIALIZED, Fe.onSdkInitialized), x.b.isUsingSubscriptionWorkaround()) {
                                if (!Ui.config || !Ui.config.subdomain) throw new f(c.MissingSubdomain);
                                Ui.emitter.on(Ui.EVENTS.SESSION_STARTED, ui.setupSessionEventListenersForHttp), Ui.proxyFrameHost = yield xi.discoverAltOrigin(Ui.config)
                            }
                            window.addEventListener("focus", () => {
                                ie.checkAndTriggerNotificationPermissionChanged()
                            }), yield Fe.initSaveState(), yield Fe.saveInitOptions(), y.a.getWindowEnv() === H.a.CustomIframe ? yield S.a.trigger(Ui.EVENTS.SDK_INITIALIZED): yield Fe.internalInit()
                        }
                    })
                }
                Ui.pendingInit = !1, Ui.context.workerMessenger.listen(), "complete" === document.readyState || "interactive" === document.readyState ? yield e(): (E.a.debug("OneSignal: Waiting for DOMContentLoaded or readyStateChange event before continuing initialization..."), window.addEventListener("DOMContentLoaded", () => {
                    e()
        ...
        static provideUserConsent(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield T.a.setProvideUserConsent(e), e && Ui.pendingInit && (yield Ui.delayedInit())
            })
        }
        static showHttpPermissionRequest(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                E.a.debug("Called showHttpPermissionRequest(), redirecting to HTTP prompt."), Ui.showHttpPrompt(e).catch(e => E.a.info(e))
            })
        }
        static showHttpPrompt(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Ui.showSlidedownPrompt(e)
            })
        }
        static showNativePrompt() {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), yield Ui.context.promptsManager.internalShowNativePrompt()
            })
        }
        static showSlidedownPrompt(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), yield Ui.context.promptsManager.internalShowParticularSlidedown(N.Push, e)
            })
        }
        static showCategorySlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)();
                const t = B.getIsPushNotificationsEnabled();
                yield Ui.context.promptsManager.internalShowCategorySlidedown(Object.assign(Object.assign({}, e), {
                    isInUpdateMode: t
                }))
            })
        }
        static showSmsSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), yield Ui.context.promptsManager.internalShowSmsSlidedown(Object.assign({}, e))
            })
        }
        static showEmailSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), yield Ui.context.promptsManager.internalShowEmailSlidedown(Object.assign({}, e))
            })
        }
        static showSmsAndEmailSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), yield Ui.context.promptsManager.internalShowSmsAndEmailSlidedown(Object.assign({}, e))
            })
        }
        static registerForPushNotifications(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (Ui.initialized) return yield Fe.registerForPushNotifications(e);
                yield new Promise((t, i) => {
                    Ui.emitter.once(Ui.EVENTS.SDK_INITIALIZED, () => Object(d.a)(this, void 0, void 0, function*() {
                        return yield Fe.registerForPushNotifications(e), t()
                    }))
                })
            })
        }
        static getNotificationPermission(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Object(A.c)(), Ui.privateGetNotificationPermission(e)
            })
        }
        static privateGetNotificationPermission(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = yield Ui.context.permissionManager.getNotificationPermission(Ui.config.safariWebId);
                return e && e(t), t
            })
        }
        static getTags(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), Object(A.s)("getTags", e);
                const {
                    appId: t
                } = yield T.a.getAppConfig(), {
                    deviceId: i
                ...
                const {
                    tags: n
                } = yield rt.getPlayer(t, i);
                return Object(A.j)(e, n), n
            })
        }
        static sendTag(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const n = {};
                return n[e] = t, yield Ui.sendTags(n, i)
            })
        }
        static sendTags(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Object(A.c)(), Object(A.s)("sendTags", e, t), e && 0 !== Object.keys(e).length ? (Object.keys(e).forEach(t => {
                    !1 === e[t] && (e[t] = "false")
                }), yield this.context.updateManager.sendTagsUpdate(e), Object(A.j)(t, e), e) : (E.a.info(new InvalidArgumentError.a("tags", InvalidArgumentError.b.Empty)), null)
            })
        }
        static deleteTag(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Ui.deleteTags([e])
            })
        }
        static deleteTags(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (yield Object(A.c)(), Object(A.s)("deleteTags", e, t), !ji.isValidArray(e)) throw new InvalidArgumentError.a("tags", InvalidArgumentError.b.Malformed);
                0 === e.length && E.a.info(new InvalidArgumentError.a("tags", InvalidArgumentError.b.Empty));
                const i = {};
                for (const t of e) i[t] = "";
                const n = yield Ui.sendTags(i);
                if (n) {
                    const e = Object.keys(n);
                    return Object(A.j)(t, e), e
                }
                return []
            })
        }
        static setExternalUserId(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), Object(A.s)("setExternalUserId"), yield Ui.privateSetExternalUserId(e, t)
            })
        }
        static privateSetExternalUserId(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                Ri.throwIfInvalidAuthHash(t, "authHash"), yield Ui.database.setExternalUserId(e, t), yield Ui.context.updateManager.sendExternalUserIdUpdate(e, t)
            })
        }
        static getExternalUserId() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Object(A.c)(), Object(A.s)("getExternalUserId"), yield Ui.database.getExternalUserId()
            })
        }
        static removeExternalUserId() {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), Object(A.s)("removeExternalUserId"), yield Ui.privateSetExternalUserId(void 0)
            })
        }
        static addListenerForNotificationOpened(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), Object(A.s)("addListenerForNotificationOpened", e), Ui.emitter.once(Ui.EVENTS.NOTIFICATION_CLICKED, t => {
                    Object(A.j)(e, t)
                }), Ui.config && V.fireStoredNotificationClicks(Ui.config.pageUrl || Ui.config.userConfig.pageUrl)
            })
        }
        static getIdsAvailable(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), Object(A.s)("getIdsAvailable", e);
                const {
                    deviceId: t,
                    subscriptionToken: i
                } = yield T.a.getSubscription(), n = {
                    userId: t,
                    registrationId: i
                };
                return Object(A.j)(e, n), n
        ...
        static isPushNotificationsEnabled(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Object(A.c)(), Ui.privateIsPushNotificationsEnabled(e)
            })
        }
        static privateIsPushNotificationsEnabled(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                Object(A.s)("isPushNotificationsEnabled", e);
                const t = yield Ui.context.subscriptionManager.getSubscriptionState();
                return Object(A.j)(e, t.subscribed && !t.optedOut), t.subscribed && !t.optedOut
            })
        }
        static setSubscription(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), Object(A.s)("setSubscription", e);
                const t = yield T.a.getAppConfig(), {
                    appId: i
                } = t, n = yield T.a.getSubscription(), {
                    deviceId: s
                } = n;
                if (!t.appId) throw new m(o.MissingAppId);
                if (!ji.isValidBoolean(e)) throw new InvalidArgumentError.a("newSubscription", InvalidArgumentError.b.Malformed);
                if (!s) return void E.a.info(new b(r.NoDeviceId));
                const a = {
                        notification_types: ie.getNotificationTypeFromOptIn(e)
                    },
                    c = yield T.a.getExternalUserIdAuthHash();
                c && (a.external_user_id_auth_hash = c), n.optedOut = !e, yield rt.updatePlayer(i, s, a), yield T.a.setSubscription(n), V.onInternalSubscriptionSet(n.optedOut), V.checkAndTriggerSubscriptionChanged()
            })
        }
        static isOptedOut(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Object(A.c)(), Ui.internalIsOptedOut(e)
            })
        }
        static internalIsOptedOut(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                Object(A.s)("isOptedOut", e);
                const {
                    optedOut: t
                } = yield T.a.getSubscription();
                return Object(A.j)(e, t), t
            })
        }
        static optOut(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (yield Object(A.c)(), Object(A.s)("optOut", e, t), !ji.isValidBoolean(e)) throw new InvalidArgumentError.a("doOptOut", InvalidArgumentError.b.Malformed);
                yield Ui.setSubscription(!e), Object(A.j)(t)
            })
        }
        static getEmailId(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), Object(A.s)("getEmailId", e);
                const t = (yield T.a.getEmailProfile()).subscriptionId;
                return Object(A.j)(e, t), t
            })
        }
        static getSMSId(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), Object(A.s)("getSMSId", e);
                const t = yield T.a.getSMSProfile(), {
                    subscriptionId: i
                } = t;
                return Object(A.j)(e, i), i
            })
        }
        static getUserId(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), Object(A.s)("getUserId", e);
                const t = (yield T.a.getSubscription()).deviceId;
                return Object(A.j)(e, t), t
            })
        }
        static getRegistrationId(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), Object(A.s)("getRegistrationId", e);
                const t = (yield T.a.getSubscription()).subscriptionToken;
                return Object(A.j)(e, t), t
            })
        }
        static getSubscription(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Object(A.c)(), yield Ui.privateGetSubscription(e)
            })
        }
        static privateGetSubscription(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                Object(A.s)("getSubscription", e);
                const t = !(yield T.a.getSubscription()).optedOut;
                return Object(A.j)(e, t), t
            })
        }
        static sendSelfNotification(e = "OneSignal Test Message", t = "This is an example notification.", i = `${new URL(location.href).origin}?_osp=do_not_open`, n, s, a) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(A.c)(), Object(A.s)("sendSelfNotification", e, t, i, n, s, a);
                const c = yield T.a.getAppConfig(), l = yield T.a.getSubscription();
                if (!c.appId) throw new m(o.MissingAppId);
                if (!(yield Ui.isPushNotificationsEnabled())) throw new b(r.NoDeviceId);
                if (!ji.isValidUrl(i)) throw new InvalidArgumentError.a("url", InvalidArgumentError.b.Malformed);
                if (!ji.isValidUrl(n, {
                        allowEmpty: !0,
                        requireHttps: !0
                    })) throw new InvalidArgumentError.a("icon", InvalidArgumentError.b.Malformed);
                l.deviceId && (yield rt.sendNotification(c.appId, [l.deviceId], {
                    en: e
                }, {
                    en: t
                }, i, n, s, a))
        ...
        static sendOutcome(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const i = Ui.config.userConfig.outcomes;
                if (!i) return void E.a.error(`Could not send ${e}. No outcomes config found.`);
                const n = new Xe(Ui.config.appId, i, e, !1);
        ...
        static sendUniqueOutcome(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = Ui.config.userConfig.outcomes;
                if (!t) return void E.a.error(`Could not send ${e}. No outcomes config found.`);
                const i = new Xe(Ui.config.appId, t, e, !0);
                if (!(yield i.beforeOutcomeSend())) return;
                const n = yield i.getAttribution();
                if (n.type === Ge.NotSupported) return void E.a.warn("You are on a free plan. Please upgrade to use this functionality.");
                const {
                    notificationIds: o
    ...
    Ui.VERSION = h.a.version(), Ui._VERSION = h.a.version(), Ui.sdkEnvironment = y.a, Ui._notificationOpenedCallbacks = [], Ui._idsAvailable_callback = [], Ui._defaultLaunchURL = null, Ui.config = null, Ui._sessionInitAlreadyRunning = !1, Ui._isNotificationEnabledCallback = [], Ui._subscriptionSet = !0, Ui.modalUrl = null, Ui._windowWidth = 650, Ui._windowHeight = 568, Ui._isNewVisitor = !1, Ui._channel = null, Ui.timedLocalStorage = Ie, Ui.initialized = !1, Ui._didLoadITILibrary = !1, Ui.notifyButton = null, Ui.store = v, Ui.environment = h.a, Ui.database = T.a, Ui.event = S.a, Ui.browser = g.a, Ui.slidedown = null, Ui.log = E.a, Ui.api = rt, Ui.indexedDb = _i.a, Ui.mainHelper = ie, Ui.subscriptionHelper = te, Ui.httpHelper = Mi, Ui.eventHelper = V, Ui.initHelper = Fe, Ui.pendingInit = !0, Ui.emitter = new se.a, Ui.cache = {}, Ui.SERVICE_WORKER_UPDATER_PATH = "OneSignalSDKUpdaterWorker.js", Ui.SERVICE_WORKER_PATH = "OneSignalSDKWorker.js", Ui.SERVICE_WORKER_PARAM = {
        scope: "/"
    }, Ui._LOGGING = !1, Ui.LOGGING = !1, Ui._usingNativePermissionHook = !1, Ui._initCalled = !1, Ui.__initAlreadyCalled = !1, Ui.checkAndWipeUserSubscription = function() {}, Ui.DeviceRecord = G, Ui.SecondaryChannelDeviceRecord = lt, Ui.notificationPermission = k, Ui._initHttp = Mi.initHttp, Ui._initPopup = (() => Ui.subscriptionPopup.subscribe()), Ui.POSTMAM_COMMANDS = {
        CONNECTED: "connect",
    ...
    }, $.ensureBackwardsCompatibility(Ui), E.a.info(`%cOneSignal Web SDK loaded (version ${Ui._VERSION},\n  ${y.a.getWindowEnv().toString()} environment).`, Object(A.k)("bold")), E.a.debug(`Current Page URL: ${"undefined"==typeof location?"NodeJS":location.href}`), E.a.debug(`Browser Environment: ${g.a.name} ${g.a.version}`)
}, function(e, t) {
    var i;
    i = function() {
        return this
