    ...
    [139], {
            ...
            ! function(o, s, r) {
                ...
                function _(e, t) {
                    ...
                    for (n = function(e) {
                        ...
                        }(e), o = 0; o < n.length; ++o) i = n[o], h[i] && (i = h[i]), t && "keypress" != t && u[i] && (i = u[i], s.push("shift")), b(i) && s.push(i);
                    return {
                        key: i,
                        modifiers: s,
                        action: t = f(i, s, t)
                ...
                function g(e) {
                    ...
                    function l(e, n, o, s, r, a) {
                        ...
                        for ("keyup" == p && b(e) && (n = [e]), c = 0; c < t._callbacks[e].length; ++c)
                            if (l = t._callbacks[e][c], (s || !l.seq || i[l.seq] == l.level) && p == l.action && ("keypress" == p && !o.metaKey && !o.ctrlKey || (u = n, h = l.modifiers, u.sort().join(",") === h.sort().join(",")))) {
                                var m = !s && l.combo == r,
                    ...
                    t._handleKey = function(e, t, n) {
                        var i, o = l(e, t, n),
                            ...
                            h = 0,
                            d = !1;
                        for (i = 0; i < o.length; ++i) o[i].seq && (h = Math.max(h, o[i].level));
                        for (i = 0; i < o.length; ++i)
                            if (o[i].seq) {
                                if (o[i].level != h) continue;
                                d = !0, s[o[i].seq] = 1, u(o[i].callback, n, o[i].combo, o[i].seq)
                            } else d || u(o[i].callback, n, o[i].combo);
                        var p = "keypress" == n.type && r;
                        n.type != a || b(e) || p || c(s), r = d && "keydown" == n.type
            ...
            class E extends s.Component {
                ...
                render() {
                    const {
                        ...
                        submitButtonStyle: l,
                        submitButtonType: u
                    } = this.props, [h, d] = "string" == typeof o ? o.split("?") : [], p = `${encodeURI(h||"/")}${d?`?${d}`:""}`, b = s.createElement(_.a, {
            ...
            class w extends c.Component {
                constructor(...e) {
                    super(...e), r()(this, "_renderAriaOnly", (() => {
                        ...
                        return c.createElement(d, null, c.createElement(h.a, null, c.createElement(b.a, {
                            id: "Toast"
                        }, ((h, d) => c.createElement(a.Provider, {
                            viewType: "toast"
        ...
        donR: function(e, t, n) {
                ...
                constructor(e) {
                    r()(this, "_handleKeyDown", (e => {
                        const {
                            ...
                            metaKey: i,
                            target: o = {}
                        } = e, s = o instanceof HTMLInputElement ? o.nodeName : void 0;
                        (t || n || i || !((e = "") => -1 !== h.indexOf(e.toLowerCase()))(s)) && (this.detach(), this.detected())
                    })), r()(this, "attach", (() => {
            ...
            var P = (e, t, n) => {
                ...
                A = n("sebV"),
                L = n("rxPX");
            const R = (e, t) => t.location.pathname.includes("/intent/"),
                x = (e, t) => t.location.pathname.includes("/login");
            var B = Object(L.a)().propsFromState((() => ({
                    isIntentRoute: R,
                    isLoginRoute: x
                }))).adjustStateProps((({
                    isIntentRoute: e,
            ...
            class j extends O.Component {
                constructor(...e) {
                    super(...e), r()(this, "_isStandaloneApp", A.a.isStandaloneApp()), r()(this, "state", {
            ...
            var $ = e => {
                    if (!F.e(e.getState())) return;
                    const t = e.dispatch(Object(I.d)("BADGE_TIMERS")({
                            showToast: !1,
                            [H.a.AccessDeniedByBouncer]: {
                                customAction: W.a
                            }
                        })),
                        n = n => e.dispatch(n).catch(t),
                        i = new V.b(3e4).interval((() => {
                            "background" !== X.a.currentState && (n(Object(Y.b)()), Object(z.b)(e.getState()).forEach(n))
                        }));
                    i.start(), G(i);
                    const o = new V.b(3e4).interval((() => {
                        "background" !== X.a.currentState && e.dispatch(q.b.fetchInitialOrTop({
                            polling: !0
                        })).catch(t)
                    }));
                    o.start(), G(o);
                    X.a.addEventListener("change", (e => {
                        "active" === e && (G(i), G(o))
                    }))
                },
                J = n("+Aie"),
            ...
            class ce extends O.PureComponent {
                constructor(e, t) {
                    super(e, t), r()(this, "_renderButtons", (() => O.createElement(O.Fragment, null, O.createElement(oe.a, {
                        onClick: this._handleInfo,
                        size: "small",
                        type: "destructive"
                    }, "Info"), O.createElement(oe.a, {
                        onClick: this._handleClear,
                        size: "small",
                        type: "destructive"
                    }, "Clear"), O.createElement(oe.a, {
                        ...
                        if (window.confirm(e)) {
                            const e = new URL(ie.b.get());
                            e.searchParams.set("dtab_local", ""), e.searchParams.set("tts_token", ""), ie.b.navigateTo(e.toString())
                        }
                    })), r()(this, "_handleClose", (() => {
                        const {
                            dtabAll: e,
                ...
                render() {
                    const {
                        dtabAll: e,
                        ttsToken: t
                    } = this.props, n = t || e ? O.createElement(ee.a, {
                        style: le.root
                    }, O.createElement(se.a, {
                        isLarge: !0,
                        style: le.container,
                        withGutter: !0
                    }, O.createElement(re.c, {
                        color: "whiteOnColor",
                        numberOfLines: 1,
                        size: "small",
                        style: le.text
            ...
            var me = {
                    init: e => {
                        ...
                        pe.b.isDesktopOS() && pe.b.isIE() && X.a.addEventListener("change", t)
                    }
                },
                be = n("pXBW"),
                fe = n("nS6Z");
            ...
            class we {
                constructor(e) {
                    ...
                    this.updateSubscriptions = t, this.throttlePeriod = n, null !== n && n >= 0 && (this._applyPendingState = Object(Ee.a)(this._applyPendingState, n, {
                        leading: !1
                    }))
                }
                setConfig(e = null, t = []) {
            ...
            class ke {
                constructor({
                    ...
                    r()(this, "isSuspended", !1), r()(this, "eventSourceConnector", null), r()(this, "subscriptionsByTopic", {}), r()(this, "_closeEventSource", (() => {
                        ...
                        e === ke.SYSTEM_CONFIG_TOPIC && this.eventSourceConnector && this.livePipelineResubscriber.setConfig(t, this.eventSourceConnector.getAutoSubscribedTopics());
                ...
                _reconcileTopics() {
                    ...
                    t && this._clearExpiryTimeout(), this.livePipelineResubscriber.setTopics(e), this.eventSourceConnector && this.eventSourceConnector.setTopics(e), t && !this.eventSourceConnector ? (this._closeEventSource(), this.eventSourceConnector = new Se({
                        ...
                        topics: e
                    })) : t || !this.eventSourceConnector || this.connectionExpiryTimeoutId || (this.connectionExpiryTimeoutId = setTimeout(this._closeEventSource, ke.UNUSED_CONNECTION_EXPIRY))
                }
                _clearExpiryTimeout() {
            ...
            let Te;
            r()(ke, "SYSTEM_CONFIG_TOPIC", "/system/config"), r()(ke, "UNUSED_CONNECTION_EXPIRY", 3e4);
            var Ce = {
                    isSupported: e => "EventSource" in window && e.isTrue("livepipeline_client_enabled"),
                    isSupportedAndReady(e) {
                        return this.isSupported(e) && !!Te
                    },
                    create(e, t, n) {
                        ...
                        return Te = new ke({
                            ...
                            updateSubscriptions: e => t.LivePipeline.updateSubscriptions(e).catch((e => {
                                if (e)
                                    if (e instanceof be.a && Object(H.c)(e, H.a.SessionNotFound)) Te && Te._restartEventSource();
                                    else if (!(e instanceof be.a) && e instanceof Error) return Promise.reject(e);
                                return Promise.resolve()
                            }))
                        }), X.a.addEventListener("change", (e => this._handleAppStateChange(e))), Te
                    },
                    get() {
            ...
            var Pe = e => {
                ...
                Oe = (n("MvUL"), n("Sp5X"));
            const De = ["/login/error", "/i/sms_login"];
            var Ae = e => {
                    const t = !F.e(e),
                        n = F.c(e);
                    if (t && n && Oe.a) {
                        const {
                            pathname: e
                        } = Oe.a.location; - 1 === De.indexOf(e) && Oe.a.replace({
            ...
            var Ue = (e, t, n) => {
                    const i = e => n.dispatch(Object(I.d)(e)({})),
                        o = Oe.a && Oe.a.location.query,
                        s = Le.c({
                            query: o,
                            httpReferer: document.referrer || "",
                            requestUrl: window.location.href
                        });
                    if (Object(xe.a)(s)) return Promise.resolve();
                    if (s.referer && !ie.b.isExternalUrl(s.referer) && !ie.b.isInternalRedirect(s.referer)) return Promise.resolve();
                    s.referer || (s.referer = ""), s.referral_details_str || (s.referral_details_str = ""), s.referral_type || (s.referral_type = 0);
                    const r = Object(Be.a)("external_referer");
                    r && (s.external_referer_cookie_value = r);
                    const a = s.referral_type === Le.a.Access,
                        c = { ...Me,
                            client: Object(Re.a)().clientName
                        };
                    ...
                    }).catch((() => i("OCF_EXTERNAL_REFERER"))) : Promise.resolve(), d = s ? e.Attribution.recordUserEvent({
                        event: "open",
            ...
            class Fe extends O.PureComponent {
                render() {
                    let e;
                    je.canUseDOM && (e = window.location.href);
                    const t = e ? {
                        canonical: Object(Ne.a)(e)
                    } : null;
                    return t ? O.createElement(Ke.a, null, O.createElement("link", {
                        href: t.canonical,
                        rel: "canonical"
                    })) : null
                }
            }
            var He = Object(U.a)(Fe);
            var Xe = Object(L.a)().propsFromState((() => ({
                    loginReturnPath: F.i
                }))).withAnalytics({
                ...
                Ge = n("cnVF"),
                $e = n("MWbm");
            const Je = ["/settings", "/signup", "/login/error", "/i/flow/signup", "/login/check"];
            class Ze extends O.Component {
                constructor(e, t) {
                    super(e, t), this.state = {
                        ...
                        smartLockDisabled: !1,
                        userName: ""
                    }, this._smartLockSupported = !!(window.PasswordCredential && navigator.credentials && navigator.credentials.get) && !t.loggedInUserId, this._isSmartLockDisabledFromCookie = "1" === e.getCookie(Ge.t)
                }
                componentDidMount() {
                    "/login/error" === this.props.location.pathname ? Object(qe.a)() : this._checkShouldDisplayPrompt()
                }
                componentDidUpdate(e) {
                ...
                render() {
                    ...
                    return this._shouldDisplaySmartLockPrompt() ? O.createElement($e.a, {
                        style: Qe.hidden
                    ...
                    if (this._shouldDisplaySmartLockPrompt()) {
                        ...
                        setTimeout((() => i = !1), 250), navigator.credentials.get({
                            ...
                            if (e) {
                                ...
                                smartLockDisabled: !0
                            }, qe.a), i ? this._scribeAction("cancel", {
                ...
                _shouldDisplaySmartLockPrompt(e = this.props) {
                    const {
                        ...
                        smartLockDisabled: i
                    } = this.state, o = "/login" === n || !this._isSmartLockDisabledFromCookie && !i && !Je.some((e => e === n));
                    return !t && this._smartLockSupported && o
                }
            }
            r()(Ze, "contextType", D.a), r()(Ze, "defaultProps", {
                getCookie: Be.a
            });
            const Qe = ae.a.create((e => ({
                hidden: {
                    display: "none"
                }
            })));
            var et = Object(U.a)(Xe(Ze)),
                tt = n("HPNB"),
                nt = n("ZNx0"),
                it = n("1YZw"),
                ot = Object(L.a)().propsFromState((() => ({
                    toast: it.d
                }))).propsFromActions((() => ({
                    onClose: it.c
                }))),
            ...
            var ut = ot((({
                ...
                const n = (e => e.pathname.startsWith("/explore") ? "guide" : "app")(Object(rt.f)());
                return t ? O.createElement(at.a, null, (({
                    windowWidth: i
                }) => {
                    const o = tt.a.shouldRenderAsModal(i) ? ct.a.ModalToasts : ct.a.Toasts;
        ...
        rRIm: function(e, t, n) {
            ...
            const T = p.a.b47e760d,
                ...
                O = e => {
                    if (!a.canUseDOM) return E.a;
                    return I.subscribe(e).unsubscribe
                };
            class D extends s.Component {
                constructor(...e) {
                    super(...e), o()(this, "_bindKeyboardShortcuts", (() => {
                        const {
                            ...
                            n.preventDefault(), I._listeners.length ? I.notify(t) : e.push({
                                pathname: "/explore",
                                state: {
                                    searchFocused: !0,
                                    searchPrefill: t
                        ...
                        }, a = this.props.loggedInUserScreenName ? s : i;
                        this._unbindKeyboardShortcuts = Object(r.a)(a)
                    })), o()(this, "_handleKeyDown", (e => {
                        P(e) || "Backspace" !== e.key || (this._backspaceDown = Date.now(), e.preventDefault(), e.stopPropagation())
                    })), o()(this, "_handleKeyUp", (e => {
                        if (!P(e) && "Backspace" === e.key) {
                            e.preventDefault(), e.stopPropagation();
                            const t = this._backspaceDown,
                                n = !!Object(w.a)(t) && Date.now() - t < 500,
                                i = Object(b.a)({}, {
                ...
                render() {
                    ...
                    }, s.createElement(v.c, null, T), s.createElement(v.c, {
                        focusable: !1,
            ...
            const A = h(D);
            t.a = a.canUseDOM ? Object(y.a)(A) : Object(k.a)(null)
        },
        yt7X: function(e, t, n) {
            "use strict";
            var i = n("KEM+"),
            ...
            class k extends s.Component {
                constructor(...e) {
                    super(...e), o()(this, "state", {
                        euWarningIsOpen: !1
                    }), o()(this, "_renderMessage", (() => s.createElement(b.c, {
                        color: "white",
                        size: "small"
                        ...
                        c.a.canUseDOM && (document.cookie = p.a.serialize(S.i, "1", {
                            maxAge: 31536e3,
                            path: "/",
                            domain: ".twitter.com",
                            secure: !0
                ...
                componentDidMount() {
                    const {
                        currentCountry: e
                    } = this.props, t = this.context.featureSwitches.getArrayValue("responsive_web_eu_countries", []), n = a.canUseDOM ? p.a.parse(document.cookie) : {};
                    this.setState({
                        euWarningIsOpen: !!e && E(t, e, n)
                    })
                }
                render() {
                    return this.state.euWarningIsOpen ? s.createElement(f.a, null, (({
                        windowWidth: e
                    }) => {
                        const t = e < _.a.theme.breakpoints.medium;
                        return s.createElement(m.a, {
                            style: [T.root, t && T.rootNarrow]
                        }, this._renderMessage(), s.createElement(y.a, {
...
//# sourceMappingURL=https://ton.twitter.com/responsive-web-internal/sourcemaps/client-web/loader.AppModules.da94dd15.js.map