! function(t) {
    ...
    var n = r(36),
        ...
        s = function(t) {
            ...
            return function(d, v, y, g) {
                for (var m, b, w = i(d), x = o(w), A = n(v, y, 3), E = a(x.length), S = 0, _ = g || u, O = e ? _(d, E) : r || p ? _(d, 0) : void 0; E > S; S++)
                    if ((h || S in x) && (b = A(m = x[S], S, w), t))
                        if (e) O[S] = b;
                        else if (b) switch (t) {
                    case 3:
                        return !0;
    ...
    n("replace", 2, (function(t, e, r, n) {
        ...
        return [function(r, n) {
            ...
            for (var x = [];;) {
                ...
                if (null === A) break;
                if (x.push(A), !b) break;
                "" === String(A[0]) && (y.lastIndex = c(g, i(y.lastIndex), w))
            }
    ...
    var n = r(4),
        ...
        ut = function(t, e, r) {
            t === W && ut(X, e, r), d(t);
            var n = g(e, !0);
            return d(r), l(Q, n) ? (r.enumerable ? (l(t, N) && t[N][n] && (t[N][n] = !1), r = b(r, {
                enumerable: m(0, !1)
    ...
    t.exports = function(t, e, r, f, h, x, A) {
        ...
        if (L && (E = i(L.call(new t)), d !== Object.prototype && E.next && (l || i(E) === d || (a ? a(E, d) : "function" != typeof E[y] && c(E, y, w)), u(E, R, !0, !0), l && (p[R] = w))), h == m && j && j.name !== m && (T = !0, I = function() {
                return j.call(this)
    ...
    t.exports = function(t) {
        ...
        if (m && (g = n(g, y > 2 ? arguments[2] : void 0, 2)), null == b || v == Array && a(b))
            for (r = new v(e = u(d.length)); e > w; w++) h = m ? g(d[w], w) : d[w], c(r, w, h);
        else
            for (p = (l = b.call(d)).next, r = new v; !(f = p.call(l)).done; w++) h = m ? i(l, g, [f.value, w], !0) : f.value, c(r, w, h);
        return r.length = w, r
    }
}, function(t, e, r) {
    var n = r(5),
    ...
    A || (n = function() {
        ...
        i = void 0, t && t.enter()
    }, d || y || v || !g || !m ? w && w.resolve ? (s = w.resolve(void 0), f = s.then, a = function() {
        f.call(s, n)
    }) : a = y ? function() {
        b.nextTick(n)
    } : function() {
    ...
    i ? (D || (O.f = K, _.f = J, G(B, "buffer"), G(B, "byteOffset"), G(B, "byteLength"), G(B, "length")), n({
        ...
        })), w && w(y, N), g = y.prototype = b(B)), g.constructor !== y && l(g, "constructor", y), M && l(g, M, u), _[u] = y, n({
            global: !0,
            forced: y != v,
            sham: !D
    ...
    n("split", 2, (function(t, e, r) {
        ...
        return n = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, r) {
            ...
            for (var x = 0, A = 0, E = []; A < p.length;) {
                b.lastIndex = y ? A : 0;
                var S, _ = f(b, y ? p : p.slice(A));
                if (null === _ || (S = d(s(b.lastIndex + (y ? 0 : A)), p.length)) === x) A = c(p, A, g);
                else {
    ...
    if (i(g, !m(" 0o1") || !m("0b1") || m("+0x1"))) {
        for (var A, E = function(t) {
                var e = arguments.length < 1 ? 0 : t,
                    r = this;
                return r instanceof E && (w ? l((function() {
                    b.valueOf.call(r)
    ...
    e.default = function() {
        ...
        return function(t, e) {
            ...
            parse: function(e) {
                ...
                function Ut() {
                    var t, r, n, i, a, u, s;
                    return t = xt, 123 === e.charCodeAt(xt) ? (r = h, xt++) : (r = o, 0 === Ot && Tt(d)), r !== o && $t() !== o && (n = kt()) !== o && $t() !== o ? (i = xt, 44 === e.charCodeAt(xt) ? (a = y, xt++) : (a = o, 0 === Ot && Tt(g)), a !== o && (u = $t()) !== o && (s = Dt()) !== o ? i = a = [a, u, s] : (xt = i, i = c), i === o && (i = v), i !== o && (a = $t()) !== o ? (125 === e.charCodeAt(xt) ? (u = m, xt++) : (u = o, 0 === Ot && Tt(b)), u !== o ? (t, t = r = w(n, i)) : (xt = t, t = c)) : (xt = t, t = c)) : (xt = t, t = c), t
                }
                ...
                function Yt() {
                    var t, r, n, i, a;
                    return t = xt, $t() !== o && (r = Vt()) !== o && $t() !== o ? (123 === e.charCodeAt(xt) ? (n = h, xt++) : (n = o, 0 === Ot && Tt(d)), n !== o && $t() !== o && (i = It()) !== o && $t() !== o ? (125 === e.charCodeAt(xt) ? (a = m, xt++) : (a = o, 0 === Ot && Tt(b)), a !== o ? (t, t = N(r, i)) : (xt = t, t = c)) : (xt = t, t = c)) : (xt = t, t = c), t
                }
    ...
    var n = r(66),
        o = r.n(n),
        i = (r(102), r(16), r(67), r(29), r(83), r(156), r(37), r(85), r(30), r(86), r(64), r(118), r(88), r(119), r(161), r(162), r(163), r(22), r(53), r(135)),
        a = r.n(i),
        u = function(t) {
        ...
        c = r(23),
        s = r.n(c);
    r(124), r(92), r(94), r(95), r(96), r(39), r(54), r(97);
    ...
    var p, h = /[:\-[\]/{}()*+?.\\^$|]/g,
        ...
        D = function(t) {
            ...
            return g(m.APP_SHELL_CACHE_KEY, i, w(), "text/html; charset=utf-8").then(u)
        };
    ...
    var lt = Object.freeze({
        ...
        bt = r.p + "icon-default.ee534d85.png",
        wt = (r(214), r(215), r(218), r(99)),
        xt = r.n(wt);
    [{
        locale: "ar",
        pluralRuleFunction: function(t, e) {
...
//# sourceMappingURL=https://ton.twitter.com/responsive-web-internal/sourcemaps/client-serviceworker/serviceworker.00865ca5.js.map